...
function t2Click() {
    $("#cnblogs_ch").append('<img style="display:none" src="https://e.cn.miaozhen.com/r/k=2272798&p=81SLM&dx=__IPDX__&rt=2&pro=s&ns=__IP__&ni=__IESID__&v=__LOC__&xa=__ADPLATFORM__&tr=__REQUESTID__&mo=__OS__&m0=__OPENUDID__&m0a=__DUID__&m1=__ANDROIDID1__&m1a=__ANDROIDID__&m2=__IMEI__&m4=__AAID__&m5=__IDFA__&m6=__MAC1__&m6a=__MAC__&m11=__OAID__&m14=__CAID__&m5a=__IDFV__&mn=__ANAME__&o="/>')
}

function deliverT2() {
    $.getJSON("https://a1.cnblogs.com/group/T2", function (n) {
        n && ($("#cnblogs_ch").html(n.T2), n.T2 && n.T2.indexOf("brands.cnblogs.com/huawei") > 0 && setTimeout(function () {
            countImpressions("ad", "T2-华为专区")
        }, 500), n.T2 && n.T2.indexOf("cloud.baidu.com/campaign/2022developer/") > 0 && setTimeout(function () {
            countImpressions("ad", "T2-百度智能云-开年见礼")
        }, 500))
    })
}

function deliverC1C2() {
    $("#cnblogs_c1 #div-gpt-ad-1592365906576-0").length && $.getScript("https://securepubads.g.doubleclick.net/tag/js/gpt.js", function () {
        deliverGoogleAdC1()
    })
}
...
function canShowAdsense() {
    ...
    return (n = $("#cnblogs_post_body"), n.length && (i = n.text(), i.length < 300)) ? !1 : (r = [1489405, 1873020, 3658314, 3349843, 3120490, 2131583, 5601171, 7783178, 2117105, 4315037, 3343865, 5106828, 9943394, 1512482, 8615503, 8495009, 8481402, 3873909, 8414234, 1718087, 6021462, 3925643, 6435456, 9242918, 6666860, ], $.inArray(cb_entryId, r) !== -1) ? !1 : !0
}
    ...
    $.ajax({
        ...
        success: function (n) {
            n && n.length > 10 && $.getJSON("https://a1.cnblogs.com/group/C3", function (n) {
                if (n && n.C3) {
                    var t = n.C3;
                    t.indexOf("gridsumdissector.com") > 0 && ($.get("https://i.gridsumdissector.com/v/?gscmd=impress&gid=gad_545_ewontdtj&ck=1075&adk=10813&autorefresh=__AUTOREFRESH__&ts=__TS__"), countImpressions("ad", "C3-字节-雇主春招"));
                    $("#sidebar_c3").html(t).show()
                } else $("#sidebar_c3").is(":visible") && $("#sidebar_c3").hide()
            })
        }
    })
}
...
function impressC1() {
    $.get("https://i.gridsumdissector.com/v/?gscmd=impress&gid=gad_545_mzyfo0un&ck=46&adk=566&autorefresh=__AUTOREFRESH__&ts=__TS__")
}

function impressC0(n, t) {
    $.get(t)
}

function impressM2(n, t) {
    $.get(t)
}

function impressC2(n, t) {
    $.get(t)
}

function impressEventC0() {
    $.get("https://i.gridsumdissector.com/v/?gscmd=impress&gid=gad_545_chxi4sjt&ck=1049&adk=10585&autorefresh=__AUTOREFRESH__&ts=__TS__")
}
...
function hideEmptyAdUnits() {
    $("#cnblogs_c1 iframe").length || $("#cnblogs_c1").hide()
}
...
function blogCommentManager() {
        ...
        $.ajax({
            ...
            success: function (n) {
                if (n) {
                    ...
                    location.hash == "#commentform" && scrollToAnchor("#commentform")
                }
            },
            error: function () {
    ...
    this.PostNewComment = function () {
        ...
        $.ajax({
            ...
            timeout: 3e4,
            success: function (n) {
                n ? (n.isSuccess ? (ShowCommentMsg("感谢您的回复:) 服务器端执行耗时" + n.duration + "毫秒"), $("#tbCommentBody").val(""), $("#btn_edit_comment").click(), commentEditor.removeComment(), $("#divCommentShow").html($("#divCommentShow").html() + n.message), markdown_highlight("#divCommentShow"), cb_mathjax_render("#divCommentShow"), zoomManager.apply("#divCommentShow img"), ResetCommentBox()) : n.message ? ShowCommentMsg(n.message) : ShowCommentMsg("抱歉，评论提交失败！麻烦反馈至 contact@cnblogs.com "), $("#btn_comment_submit").removeAttr("disabled")) : (ShowCommentMsg(errorMsg), $("#btn_comment_submit").removeAttr("disabled"))
            },
            error: function (n, t) {
                n.status === 500 ? ShowCommentMsg("抱歉，发生了错误！麻烦反馈至 contact@cnblogs.com ") : n.status === 429 ? ShowCommentMsg("抱歉，提交过于频繁，请稍后再试。") : n.status > 0 ? (ShowCommentMsg("抱歉，评论提交失败，请尝试刷新页面！"), console.log("评论提交失败，错误码：" + n.status + " 错误信息：" + n.responseText)) : ShowCommentMsg("抱歉，评论提交失败！xhr.status: " + n.status + ", textStatus: " + t);
    ...
    this.UpdateComment = function () {
        ...
        $.ajax({
            ...
            success: function (t) {
                if (t) t.isSuccess ? (ShowCommentMsg("修改成功"), $("#comment_body_" + n.commentId).html(t.message), ResetCommentBox(), commentEditor.removeComment()) : ShowCommentMsg(t.message);
                else ShowCommentMsg("抱歉！评论修改失败！请与管理员联系(contact@cnblogs.com)。")
            },
            error: function (n, t) {
                n.status === 500 ? ShowCommentMsg("抱歉！评论修改失败！请联系管理员 contact@cnblogs.com。") : (ShowCommentMsg("抱歉！评论修改失败！请尝试刷新页面。"), console.log("抱歉，评论提交失败！xhr.status: " + n.status + ", textStatus: " + t))
            }
        })
    };
    ...
    this.buildHashMap = function () {
        var t, i, n;
        if (!location.hash) return new Map;
        for (t = location.hash.substring(1).split("&").map(function (n) {
                var t = n.split("=");
                return t.length === 1 ? ["anchor", t[0]] : [t[0], t[1]]
            }), i = new Map, n = 0; n < t.length; n++) i.set(t[n][0], t[n][1]);
        return i
    };
    this.applyHashMap = function (n) {
        location.hash = "#" + [...n].map(function (n) {
            return n[0] === "anchor" ? n[1] : n[0] + "=" + n[1]
        }).join("&")
    };
    this.addToHash = function (n, t) {
        var i = this.buildHashMap();
        i.set(n, t);
        this.applyHashMap(i)
    };
    this.removeFromHash = function (n) {
        var t = this.buildHashMap();
        t.remove(n);
        this.applyHashMap(t)
    };
    this.getFromHash = function (n) {
        var t = this.buildHashMap();
        return t.get(n)
    };
    this.renderComments = function (r, u, f) {
        ...
        e || r !== 0 || this.getFromHash("anchor") === undefined || (e = !0, o = this.getFromHash("anchor"));
        r > 0 && this.addToHash("anchor", "!comments");
        var h = this.getFromHash("desc") === "true",
            c = {
                postId: cb_entryId,
                pageIndex: r,
                anchorCommentId: o,
        ...
        $.ajax({
            ...
            cache: !1,
            success: function (t) {
                t ? ($("#post_comment_count").html(t), $.ajax({
                    ...
                    cache: !1,
                    success: function (t) {
                        $("#blog-comments-placeholder").html(t);
                        $("#comment_sort").on("click", function () {
                            s.addToHash("desc", !h);
                            s.renderComments(1, u)
                        });
                        n();
                        var i = s.getFromHash("anchor");
                        e ? setTimeout(function () {
                            document.getElementById("comment_anchor_" + o).scrollIntoView()
                        }, 100) : (i === "#!comments" || i === "#comments_pager_top") && setTimeout(function () {
                ...
                })) : (n(), markdown_highlight("#blog-comments-placeholder"), $("#blog-comments-placeholder").html(""))
            },
            error: function (t) {
                t.status > 0 && $("#blog-comments-placeholder").html("抱歉！发生了错误！麻烦反馈至contact@cnblogs.com");
                n()
...
function ReplyComment(n, t) {
    ...
    return $("#tbCommentBody").focus().val("@" + i + "\n" + $("#tbCommentBody").val()), $("#span_parentcomment_id").html(n), t.length > 0 && $("#span_comment_replyto").html(t), !1
}
...
function GetQuoteComment(n) {
    ...
    return $.ajax({
        ...
        success: function (t) {
            var f, r, u, i;
            if (t) {
                for (f = $("#a_comment_author_" + n).text(), t.length > 300 && (t = t.substring(0, 300) + "..."), r = t.split("\n"), u = "@" + f + "\n", i = 0; i < r.length; i++) u += "> " + r[i].trim() + "\n";
...
function loadNewsAndKb() {
    var t = $("#under_post_card1"),
        n;
    $(t).is(":visible") && $.ajax({
        url: getAjaxBaseUrl() + "Headline",
        type: "get",
        dataType: "text",
        success: function (n) {
            $(t).html(n)
            ...
            if (n)
                if (n.indexOf("<script") < n.indexOf("<script>getFollowStatus")) {
                    if (n.indexOf("cdn.jsdelivr.net/gh/BNDong/Cnblogs-Theme-SimpleMemory") >= 0) {
                        ...
                        if (t === null || t[1].toUpperCase() === "BNDong".toUpperCase()) {
                            const t = n.match(/cdn\.jsdelivr\.net\/gh\/BNDong\/Cnblogs-Theme-SimpleMemory@v([1-2]\.\d+\.\d+)/);
                            t && t[1] <= "2.1.0" && (n = n.replace(/cdn\.jsdelivr\.net\/gh\/BNDong\/Cnblogs-Theme-SimpleMemory@v([1-2]\.\d+\.\d+)/g, "cdn.cnblogs.com/jsDelivr/gh/BNDong/Cnblogs-Theme-SimpleMemory@v$1"));
                            n = n.replace(/(GhVersions *: *["'])v1\.([0-1]\.\d+|2\.[0-5].*?),*/g, "$1v1.2.6").replace(/(Cnblogs-Theme-SimpleMemory@)v1\.([0-1]\.\d+|2\.[0-5])/gi, "$1v1.2.6")
                        }
                    }
                ...
                } else n.indexOf("错误提示：发生了异常") < 0 && $("#sidebar_news").html(n).show();
            deliverC3()
        }
    })
}
...
function loadBlogCalendar(n) {
    $.ajax({
        ...
        dataType: "text",
        success: function (n) {
            n.trim() && ($("#blog-calendar").html(n), $("#blog-calendar").show())
        }
    })
}
...
function loadBlogSideColumn() {
    $("#blog-sidecolumn").length && $.ajax({
        ...
        dataType: "text",
        success: function (n) {
            n && ($("#blog-sidecolumn").html(n), loadBlogTopLists())
        }
    })
}
...
function loadBlogTopLists() {
    $("#blog-sidecolumn").length && $.ajax({
        ...
        dataType: "text",
        success: function (n) {
            n && ($("#sidebar_recentcomments").length ? $(n).insertBefore("#sidebar_recentcomments") : $("#blog-sidecolumn").append(n))
        }
    })
}
...
function GetHistoryToday(n, t, i) {
    $.ajax({
        ...
        timeout: 1e4,
        success: function (n) {
            n ? $("#HistoryToday").html(n) : skinName === "CodingLife" && $("#HistoryToday").hide()
        }
    })
}
...
function loadOptUnderPost() {
    isLogined && $.ajax({
        ...
        dataType: "text",
        success: function (n) {
            n && ($("#opt_under_post").html(n), loadSiteHomeAuditStatus())
        }
    })
}
...
function passBlogWhitelist() {
    var n = $("#blog_whitelist_add");
    $(n).html("<span style='color:red'>添加博客到白名单...<\/span>");
    $.ajax({
        url: getAjaxBaseUrl() + "AddToWhitelist",
        type: "post",
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        data: JSON.stringify({
        ...
        success: function () {
            $(n).html("<span style='color:red'>添加到白名单成功！<\/span>")
        },
        error: function () {
            $(n).html("<span style='color:red'>添加到白名单失败! <\/span>")
        }
    })
}

function passPostWhitelist() {
    var n = $("#blog_post_whitelist_add");
    $(n).html("<span style='color:red'>添加到博文白名单...<\/span>");
    $.ajax({
        url: getAjaxBaseUrl() + "AddPostToWhitelist",
        type: "post",
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        data: JSON.stringify({
...
function privatePost() {
    var n = $("#blog_post_private");
    $(n).html("<span style='color:red'>设置为私有博文...<\/span>");
    $.ajax({
        url: getAjaxBaseUrl() + "SetPostPrivate",
        type: "post",
        data: JSON.stringify({
            postId: cb_entryId
        }),
        ...
        contentType: "application/json; charset=utf-8",
        success: function () {
            $(n).html("<span style='color:red'>设置为私有博文成功！<\/span>")
        },
        error: function () {
            $(n).html("<span style='color:red'>设置为私有博文失败! <\/span>")
        }
    })
}

function publicPost() {
    var n = $("#blog_post_public");
    $(n).html("<span style='color:red'>取消设置为私有博文...<\/span>");
    $.ajax({
        url: getAjaxBaseUrl() + "RemovePostPrivate",
        type: "post",
        data: JSON.stringify({
            postId: cb_entryId
        }),
        ...
        contentType: "application/json; charset=utf-8",
        success: function () {
            $(n).html("<span style='color:red'>取消设置为私有博文成功！<\/span>")
        },
        error: function () {
            $(n).html("<span style='color:red'>取消设置为私有博文失败! <\/span>")
        }
    })
}
...
function auditPassBlogPost() {
    ...
    $.ajax({
        ...
        contentType: "application/json; charset=utf-8",
        success: function (t) {
            t.success ? $(n).html("<span style='color:red'>博文通过成功<\/span>") : $(n).html("<span style='color:red'>博文通过失败! " + t.message + "<\/span>")
        },
        error: function () {
...
function fixPostBody() {
    ...
    n ? cb_entryId > 92e5 && $.ajax({
        ...
        var t, n;
        if (!this.onclick && (t = $(this).children(".cnblogs_code_hide"), t.length)) {
            n = this;
    ...
    }), cb_entryId <= 5928739 && $("#cnblogs_post_body div img").each(function () {
        var n = "";
        if (this.id.indexOf("Code_Closed_Image") >= 0) {
            n = this.id.substring(18);
        ...
        if (this.id.indexOf("Code_Open_Image") >= 0) {
        ...
        if (this.id.indexOf("Codehighlighter") >= 0 && this.id.indexOf("_Open_Image") >= 0) {
            n = this.id.substring(15, this.id.indexOf("_Open_Image"));
            $(this).off().on("click", function () {
                this.style.display = "none";
        ...
        if (this.id.indexOf("Codehighlighter") >= 0 && this.id.indexOf("_Closed_Image") >= 0) {
            n = this.id.substring(15, this.id.indexOf("_Closed_Image"));
            $(this).off().on("click", function () {
                this.style.display = "none";
...
function adaptOldCodeBlock(n) {
    n = !n || typeof n != "string" ? "" : n;
    $(n + " .cnblogs_Highlighter").each((n, t) => {
        const i = t.querySelectorAll("pre");
        i.forEach(n => {
            var t, i;
            const r = n.className;
            t = r.split(";").find(n => n.startsWith("brush"));
            t = t ? t.split(":")[1] : "";
            t && (n.className = "language-" + t);
            i = n.querySelector("code");
            i || (i = document.createElement("code"), i.innerHTML = n.innerHTML, n.innerHTML = "", n.append(i))
        })
    })
}
...
function cb_mathjax_render(n) {
    if (cb_enable_mathjax)
        if ($(".katex-mathml").length) $("head").append($('<link rel="stylesheet" type="text/css" />').attr("href", "https://common.cnblogs.com/katex/0.12.0/katex.min.css")), $.getScript("https://common.cnblogs.com/katex/0.12.0/katex.min.js", function () {
...
function cnblogs_code_show(n) {
    var t = n ? $("#cnblogs_code_open_" + n) : $(".cnblogs_code_open").first(),
        i = n ? $("#code_img_closed_" + n) : $(".code_img_closed"),
        r = n ? $("#code_img_opened_" + n) : $(".code_img_opened");
    t.css("display") === "none" && (t.parent().find("span.cnblogs_code_collapse").hide(), t.show(), r.show(), i.hide(), $(t).find("span.cnblogs_code_copy").length || showCopyCode(t))
}

function cnblogs_code_hide(n, t) {
    var i = n ? $("#cnblogs_code_open_" + n) : $(".cnblogs_code_open").first(),
        r = n ? $("#code_img_closed_" + n) : $(".code_img_closed"),
        u = n ? $("#code_img_opened_" + n) : $(".code_img_opened");
    i.css("display") != "none" && (i.hide(), u.hide(), r.show(), i.parent().find("span.cnblogs_code_collapse").show(), t.stopPropagation ? t.stopPropagation() : window.event && (window.event.cancelBubble = !0))
}
...
function fix_code_collapse_span(n) {
    var t;
    /Codehighlighter1_\d+_\d+_Closed_Text/gi.test(n.id) && $(n).hide();
    t = /Codehighlighter1_\d+_\d+_Open_Text/gi;
    t.test(n.id) && $(n).show()
}
...
function getCnblogsCodeText(n) {
    ...
    for (r = r.replace(/\r\n/g, "\n"), r = r.replace(/\nView Code/g, ""), i = r.split("\n").filter(function (n) {
            return n
        }), u = !0, t = 1; t <= i.length; t++) {
        if (i[t - 1] = i[t - 1].trim(), u = i[t - 1].indexOf(t) === 0, !u) break;
        i[t - 1] = i[t - 1].substr(t.toString().length) + "\n";
        i[t - 1][0] === " " && (i[t - 1] = i[t - 1].substr(1))
    }
    if (u)
        for (r = "", f = 0; f < i.length; f++) r += i[f];
    return typeof Encoder != undefined && (r = Encoder.htmlDecode(r)), $.trim(r)
}
...
function bindLegacyCollapseImages() {
    $("img[id$='_Closed_Image']").off("click").on("click", function () {
        code_collapse_toggle(this)
    });
    $("img[id$='_Open_Image']").off("click").on("click", function () {
        code_collapse_toggle(this)
    })
}
...
function updatePostStats(n, t, i, r, u) {
    $.ajax({
        ...
        dataType: "json",
        success: function (n) {
            for (var f = 0; f < n.length; f++) t && t(n[f].postId, n[f].viewCount), i && i(n[f].postId, n[f].feedbackCount), r && r(n[f].postId, n[f].diggCount), u && u(n[f].postId, n[f].buryCount)
        }
    })
}
...
function WarpClass(n, t, i, r) {
    ...
    e && u && (u.style.display && u.style.display != "block" ? (u.style.display = "block", e.className = "UnWarp", r && eval(r), f && (f.style.display = "block")) : (u.style.display = "none", e.className = "Warp", f && (f.style.display = "none")))
}
...
function votePost(n, t, i) {
    ...
    $.ajax({
        ...
        error: function (n, t) {
            n.status > 0 && (n.status === 500 ? $("#digg_tips").html("抱歉！发生了错误！麻烦反馈至contact@cnblogs.com") : n.stack === 429 ? $("#digg_tips").html("抱歉，提交过于频繁，请稍后再试") : ($("#digg_tips").html("抱歉，发生了错误，请尝试刷新页面！"), console.log("点赞失败，" + n.status + ", textStatus" + t)))
        }
    })
}
...
function voteComment(n, t, i, r) {
    ...
    return n ? (r || (r = !1), f = {
        ...
        voteType: t,
        isAbandoned: r
    }, r ? u.decreaseCommentVoteCount(u.current) : u.increaseCommentVoteCount(u.current), $.ajax({
    ...
    }), !1) : (u.showErrorMessage("推荐出错！commentId不正确"), !1)
}

function getGACustom() {
    var n = {};
    return n.dimension1 = skinName, isLogined && typeof visitorUserId != "undefined" && (n.userId = visitorUserId), typeof currentPostDateAdded != "undefined" && currentPostDateAdded && (n.dimension2 = currentPostDateAdded), n
}
...
function getRecommendedList() {
    ...
    $.ajax({
        ...
        success: function (t) {
            var r, i;
            if (t && t.length >= 5) {
                for (r = '<div class="recomm-block"><b>相关博文：<\/b><br>', i = 0; i < t.length && i < 5; i++) r += '·  <a title="' + t[i].title + '" href="' + t[i].url.replace("http://", "https://") + '" target="_blank" onclick="clickRecomItmem(' + t[i].itemId + ')">' + t[i].title + "<\/a><br />";
...
function PutInWz() {
    ...
    window.open("https://wz.cnblogs.com/create?t=" + encodeURIComponent(f) + "&u=" + encodeURIComponent(u.location.href) + "&c=" + encodeURIComponent("") + "&i=0", "_blank", "width=" + n + ",height=" + t + ",toolbars=0,resizable=1,left=" + i + ",top=" + r)
}
...
function AddToWz(n) {
    var r = 480,
        ...
        i;
    try {
        t = window.btoa(unescape(encodeURIComponent(t.replace(/\"/g, "&quot;"))))
    } catch (h) {
        t = encodeURIComponent(t.replace(/</g, "&lt;").replace(/>/g, "&gt;"));
        f = 0
    }
    i = "https://wz.cnblogs.com/create?t=" + t + "&u=" + encodeURIComponent(s.location.href) + "&c=" + encodeURIComponent("") + "&bid=" + n + "&i=0";
    f == 1 && (i += "&base64=1");
    ...
    loadLink(location.protocol + "//common.cnblogs.com/scripts/artDialog/ui-dialog.css", function () {
        loadScript(location.protocol + "//common.cnblogs.com/scripts/artDialog/dialog-min.js", function () {
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                success: function (t) {
                    t == "未登录" ? account.login() : (showFollowMsg(t), t == "关注成功" && followByGroup(n, !0))
                },
                error: function (n) {
            ...
            var t = dialog({
                ...
                ok: function () {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        success: function (n) {
                            n == "未登录" ? account.login() : showFollowMsg(n)
                        },
                        error: function (n) {
                            n.status > 0 && showFollowMsg("抱歉！发生了错误！麻烦反馈至contact@cnblogs.com")
                        }
...
function provisionWechatShare() {
    var i = document.querySelector('meta[name="description"]'),
        n, t;
    i && (n = "https://common.cnblogs.com/logo_square.png", t = document.querySelector("#cnblogs_post_body img"), t && (n = t.src), $.getScript("https://res.wx.qq.com/open/js/jweixin-1.6.0.js", function () {
...
function updateVisitorPreference() {
    $.ajax({
        type: "get",
        url: "/pref",
        success: function (n) {
            n && (n.liteMode ? turnOnLiteMode() : turnOffLiteMode())
        }
    })
}

function turnOffLiteMode() {
    $("#navbar_lite_mode_on").hide()
}

function turnOnLiteMode() {
    $("#navbar_lite_mode_on").show()
}

function countClicks(n, t) {
...
function countCreativeClicks(n) {
    countClicks("ad", n)
}

function countImpressions(n, t) {
    setTimeout(function () {
        typeof gtag != "undefined" && gtag("event", "impression", {
            event_category: n,
            event_label: t
        })
    }, 50)
...
function countCreativeImpressions(n) {
    countImpressions("ad", n)
}

function logCreativeClick() {
    return
}

function logCreativeImpression() {
    return
}
...
! function () {
    function n(r) {
        var f = t[r],
            u;
        return void 0 !== f ? f.exports : (u = t[r] = {
            exports: {}
        }, i[r].call(u.exports, u, u.exports, n), u.exports)
    }
    var i = {
            3114: function (n, t, i) {
                n.exports = i(8981)
            ...
            8266: function (n) {
                ! function (t, i) {
                    ...
                    return (() => {
                        ...
                        var t = {
                                607: function (n, t, i) {
                                    var e, l = this && this.__extends || (e = function (n, t) {
                                        ...
                                        r = this && this.__awaiter || function (n, t, i, r) {
                                                ...
                                                return function (o) {
                                                    return function (e) {
                                                        ...
                                                        for (; r;) try {
                                                            ...
                                                            switch (u = 0, i && (e = [2 & e[0], i.value]), e[0]) {
                                                                case 0:
                                                                case 1:
                                                                    i = e;
                                                                    break;
                                    ...
                                    t.HljsHighlighter = t.PrismHighlighter = t.BaseCodeHighlighter = t.Factory = void 0;
                                    var a = i(89),
                                        f = i(447),
                                        o = window,
                                        v = function (n) {
                                            for (var i, u, t = 0, r = null !== (i = Array.from(n.classList).filter(function (n) {
                                                    return n.toLowerCase().endsWith("sql")
                                                })) && void 0 !== i ? i : []; t < r.length; t++) u = r[t], n.classList.remove(u), n.classList.add("language-sql")
                                        },
                                        y = function () {
                                            function n() {}
                                            return n.ConfigCodeHighlightOptions = function (n) {
                                                this.options = Object.assign({}, this.options, n)
                                            }, n.UseCnblogsCodeHighlightOptions = function () {
                                                this.ConfigCodeHighlightOptions(a.cnblogsCodeHighlightAdapterOptions)
                                            }, n.CreateCodeHighlighter = function (n, t, i) {
                                                var r;
                                                switch (i && this.ConfigCodeHighlightOptions(i), n) {
                                                    case "highlight.js":
                                                        r = new c;
                                                        break;
                                                    case "prismjs":
                                                        ...
                                                        break;
                                                    default:
                                                        throw Error("unknown highlight engine");
                                                }
                                                return t || (t = r.highlighterOptions.defaultTheme), r.setTheme(t).then(), r
                                            }, n.options = Object.assign({}, a.defaultCodeHighlightAdapterOptions), n
                                        }();
                                    t.Factory = y;
                                    s = function () {
                                        function n() {
                                            this.removeLinkElements("link[rel=stylesheet][prismjs]");
                                            this.removeLinkElements("link[rel=stylesheet][hljs]")
                                        }
                                        return Object.defineProperty(n.prototype, "enableCodeLineNumber", {
                                            get: function () {
                                                return !1
                                            },
                                            enumerable: !1,
                                            configurable: !0
                                        }), Object.defineProperty(n.prototype, "adapterOptions", {
                                            get: function () {
                                                return y.options
                                            },
                                            enumerable: !1,
                                            configurable: !0
                                        }), n.prototype.highlightAllUnder = function (n, t, i) {
                                            return r(this, void 0, void 0, function () {
                                                var o, s, f, h, r, e, c, l = this;
                                                return u(this, function (u) {
                                                    switch (u.label) {
                                                        case 0:
                                                            return o = "string" == typeof n ? document.querySelector(n) : n, (s = Array.from(o.querySelectorAll("pre code")).map(function (n) {
                                                                return n
                                                            })).length > 0 ? [4, this.ensureResourcesLoaded()] : [3, 2];
                                                        case 1:
                                                            u.sent();
                                                            u.label = 2;
                                                        case 2:
                                                            for (f = [], h = function (n) {
                                                                    var u = n.parentElement,
                                                                        r = n;
                                                                    if (t && !t(u, r)) return "continue";
                                                                    f.push(new Promise(function (n, t) {
                                                                        l.highlight(r).then(function () {
                                                                            i && i(u, r);
                                                                            n()
                                                                        }, function () {
                                                                            return t()
                                                                ...
                                                                }, r = 0, e = s; r < e.length; r++) c = e[r], h(c);
                                        ...
                                        }, n.prototype.loadStyles = function (n) {
                                            var t;
                                            return r(this, void 0, void 0, function () {
                                                var s, r, i, e, o;
                                                return u(this, function (u) {
                                                    switch (u.label) {
                                                        case 0:
                                                            for (s = null !== (t = this.highlighterOptions.stylesheets) && void 0 !== t ? t : [], r = [], i = 0, e = s; i < e.length; i++) o = e[i], r.push(f.loadExternalCss(o.tagId, o.href, n));
                                        ...
                                        }, n.prototype.setTheme = function (n, t) {
                                            var i;
                                            return r(this, void 0, void 0, function () {
                                                var r, e, o;
                                                return u(this, function (u) {
                                                    switch (u.label) {
                                                        case 0:
                                                            if (!this.highlighterOptions.defaultTheme) throw Error("default theme not configured!");
                                                            return n || (n = this.highlighterOptions.defaultTheme), r = "highlighter-theme-" + n, e = !1, null === (i = document.querySelectorAll("link[id*=highlighter-theme-]")) || void 0 === i || i.forEach(function (n) {
                                                                n.id !== r ? n.remove() : e = !0
                                                            }), e ? [2] : (o = this.highlighterOptions.themeBaseUrl + "/" + n + ".css", [4, f.loadExternalCss(r, o, t)]);
                                                        case 1:
                                                            return u.sent(), [2]
                                                    }
                                                })
                                            })
                                        }, n.prototype.tryApplyLang = function (n) {
                                            var t, i, r, f, e, u;
                                            n && (f = Array.from(n.classList), e = null !== (r = null === (i = null === (t = n.parentElement) || void 0 === t ? void 0 : t.tagName) || void 0 === i ? void 0 : i.toLowerCase()) && void 0 !== r ? r : "", f.findIndex(function (n) {
                                                return n.startsWith("language-")
                                            }) < 0 && "pre" === e && (u = Array.from(n.parentElement.classList).find(function (n) {
                                                return n.startsWith("language-")
                                            }), u && n.classList.add(u)))
                                        }, n.prototype.setBodyClass = function (n) {
                                            var i = ["prismjs-engine", "hljs-engine"],
                                                t = window.document.body.classList;
                                            switch (t.remove.apply(t, i), n) {
                                                case "prismjs":
                                                    t.add(i[0]);
                                                    break;
                                                case "highlight.js":
                                        ...
                                        }, n.prototype.filterCodeContent = function (n) {
                                            var t, i, r, f, e, u;
                                            if (!n) return "";
                                            if (t = document.createElement("code"), t.style.opacity = "0", t.style.width = "0", t.style.height = "0", t.style.whiteSpace = "pre", "code" === n.tagName.toLowerCase()) t.innerHTML = n.innerHTML;
                                            else {
                                                if ("pre" !== n.tagName.toLowerCase() || !n.querySelector("code")) return "";
                                                t.innerHTML = n.querySelector("code").innerHTML
                                            }
                                            return i = t.querySelector(".line-numbers-rows"), i && i.remove(), r = t.querySelectorAll(".hljs-ln-line.hljs-ln-numbers"), null == r || r.forEach(function (n) {
                                                return n.remove()
                                            }), document.body.append(t), u = t.innerText, t.remove(), n.innerHTML = (f = u, (e = document.createElement("div")).textContent = f, e.innerHTML), u
                                        }, n.prototype.removeLinkElements = function (n) {
                                            var t;
                                            null === (t = document.querySelectorAll(n)) || void 0 === t || t.forEach(function (n) {
                                                return n.remove()
                                            })
                                        }, n
                                    }();
                                    t.BaseCodeHighlighter = s;
                                    h = function (n) {
                                        function t() {
                                        ...
                                        return l(t, n), Object.defineProperty(t.prototype, "highlighterOptions", {
                                            get: function () {
                                                return this.adapterOptions.prism
                                            },
                                            enumerable: !1,
                                            configurable: !0
                                            ...
                                            enumerable: !1,
                                            configurable: !0
                                        }), Object.defineProperty(t.prototype, "enableCodeLineNumber", {
                                            get: function () {
                                                return this.adapterOptions.enableCodeLineNumber
                                            },
                                            enumerable: !1,
                                            configurable: !0
                                            ...
                                            return r(this, void 0, void 0, function () {
                                                return u(this, function (t) {
                                                    switch (t.label) {
                                                        case 0:
                                                            return [4, this.ensureResourcesLoaded()];
                                                        case 1:
                                                            return t.sent(), this.adapterOptions.enableCodeLineNumber && Array.from(n.classList).findIndex(function (n) {
                                                                return "line-numbers" === n
                                                            }) < 0 ? n.classList.add("line-numbers") : (n.classList.remove("line-numbers"), "pre" === n.parentElement.tagName.toLowerCase() && n.parentElement.classList.remove("line-numbers")), this.tryApplyLang(n), this.setBodyClass("prismjs"), this.filterCodeContent(n), v(n), Prism.highlightElement(n, !1), [2]
                                                    }
                                                })
                                            })
                                        }, t.prototype.ensureResourcesLoaded = function () {
                                            return r(this, void 0, void 0, function () {
                                                var n;
                                                return u(this, function (t) {
                                                    switch (t.label) {
                                                        case 0:
                                                            return t.trys.push([0, 4, , 5]), [4, this.loadPrismAsync()];
                                                        case 1:
                                                            return t.sent(), [4, Promise.all([this.loadPrismAutoLoader(), this.loadPrismLineNumberPlugin()])];
                                                        case 2:
                                                            return t.sent(), [4, this.loadStyles([this._linkAttr])];
                                                        case 3:
                                                            return t.sent(), [3, 5];
                                                        case 4:
                                                            return n = t.sent(), console.error(n), [2];
                                                        case 5:
                                                            return [2]
                                                    }
                                                })
                                            })
                                        }, t.prototype.loadPrismAsync = function () {
                                            return r(this, void 0, void 0, function () {
                                                var n;
                                                return u(this, function (t) {
                                                    switch (t.label) {
                                                        case 0:
                                                            return o.Prism = o.Prism || {}, Prism.manual = !0, n = this.adapterOptions.prism.highlighterScriptPath, [4, f.loadExternalScript("prismjs-script", n)];
                                                        case 1:
                                                            return t.sent(), [2]
                                                    }
                                                })
                                            })
                                        }, t.prototype.loadPrismAutoLoader = function () {
                                            var n;
                                            return r(this, void 0, void 0, function () {
                                                var t, i;
                                                return u(this, function (r) {
                                                    switch (r.label) {
                                                        case 0:
                                                            return t = !!(null === (n = o.Prism.plugins) || void 0 === n ? void 0 : n.autoloader), i = this.adapterOptions.prism.autoLoaderPluginPath, t ? [3, 2] : [4, f.loadExternalScript("prismjs-autoloader-script", i)];
                                                        case 1:
                                                            r.sent();
                                                            r.label = 2;
                                                        case 2:
                                        ...
                                        }, t.prototype.loadPrismLineNumberPlugin = function () {
                                            return r(this, void 0, void 0, function () {
                                                var n;
                                                return u(this, function (t) {
                                                    switch (t.label) {
                                                        case 0:
                                                            if (!this.enableCodeLineNumber) return [2];
                                                            if (!this.adapterOptions.prism.lineNumberStylePath) throw Error("lineNumberStylePath not configured");
                                                            if (!this.adapterOptions.prism.lineNumberPluginPath) throw Error("lineNumberPluginPath not configured");
                                                            return f.loadExternalCss("prism-line-numbers-style", this.adapterOptions.prism.lineNumberStylePath, [{
                                                                name: "prismjs",
                                                                value: ""
                                                            }]).then(), n = f.loadExternalScript("prism-line-numbers-script", this.adapterOptions.prism.lineNumberPluginPath), [4, Promise.all([n])];
                                                        case 1:
                                                            return t.sent(), [2]
                                                    }
                                                })
                                    ...
                                    c = function (n) {
                                        ...
                                        return l(t, n), Object.defineProperty(t.prototype, "highlighterOptions", {
                                            get: function () {
                                                return this.adapterOptions.hljs
                                            },
                                            enumerable: !1,
                                            configurable: !0
                                        }), Object.defineProperty(t.prototype, "engine", {
                                            ...
                                            return r(this, void 0, void 0, function () {
                                                ...
                                                return u(this, function (t) {
                                                    switch (t.label) {
                                                        case 0:
                                                            return t.trys.push([0, 3, , 4]), [4, this.loadHljs()];
                                                        case 1:
                                                            return t.sent(), [4, this.loadStyles([this._linkAttr])];
                                                        case 2:
                                                            return t.sent(), [3, 4];
                                            ...
                                            return r(this, void 0, void 0, function () {
                                                ...
                                                return u(this, function (r) {
                                                    switch (r.label) {
                                                        ...
                                                        case 1:
                                                            r.sent();
                                                            t = this.enableCodeLineNumber;
                                                            r.label = 2;
                                                        case 2:
                                                            return r.trys.push([2, 5, , 6]), t ? [4, this.loadLineNumberPlugin()] : [3, 4];
                                                        case 3:
                                                            r.sent();
                                                            r.label = 4;
                                                        case 4:
                                                            return [3, 6];
                                                        case 5:
                                                            return i = r.sent(), console.error(i), [3, 6];
                                                        case 6:
                                                            return this.setBodyClass("highlight.js"), this.tryApplyLang(n), this.filterCodeContent(n), v(n), hljs.highlightBlock(n), t && (hljs.lineNumbersValue ? n.innerHTML = hljs.lineNumbersValue(n.innerHTML, {
                                                                singleLine: !0
                                                            }) : console.error("failed to load hljs line numbers plugin!")), n.classList.add("hljs"), [2]
                                                    }
                                                })
                                            })
                                        }, t.prototype.loadHljs = function () {
                                            return r(this, void 0, void 0, function () {
                                                var n;
                                                return u(this, function (t) {
                                                    switch (t.label) {
                                                        case 0:
                                                            return n = this.adapterOptions.hljs.highlighterScriptPath, o.hljs ? [3, 2] : [4, f.loadExternalScript("hljs-script", n)];
                                                        case 1:
                                                            t.sent();
                                                            t.label = 2;
                                                        case 2:
                                        ...
                                        }, t.prototype.loadLineNumberPlugin = function () {
                                            return r(this, void 0, void 0, function () {
                                                var n;
                                                return u(this, function (t) {
                                                    switch (t.label) {
                                                        case 0:
                                                            return n = this.adapterOptions.hljs.lineNumberPluginPath, [4, f.loadExternalScript("hljs-line-numbers", n)];
                                                        case 1:
                                                            return t.sent(), [2]
                                                    }
                                                })
                                ...
                                447: (n, t) => {
                                    ...
                                    t.dynamicLoadResource = t.loadExternalCss = t.loadExternalScript = void 0;
                                    t.loadExternalScript = function (n, i) {
                                        var r = function () {
                                            return document.head.querySelector("#" + n)
                                        };
                                        return r() ? new Promise(function (t, i) {
                                            var f = function () {
                                                    var n, t = null === (n = r()) || void 0 === n ? void 0 : n.getAttribute("data-loaded");
                                                    return t && "loading" !== t
                                                },
                                                e, u;
                                            f() ? t("loaded") : (e = 0, u = setInterval(function () {
                                                return f() ? (t("loaded"), void clearInterval(u)) : 30 * e++ > 3e4 ? (i(Error("load script timeout, tagId: " + n)), void clearInterval(u)) : void 0
                                            }, 30))
                                        }) : t.dynamicLoadResource(function () {
                                            var t = document.createElement("script");
                                            return t.id = n, t.async = !0, t
                                        }, function (n) {
                                            n.src = i
                                        })
                                    };
                                    t.loadExternalCss = function (n, i, r) {
                                        return document.head.querySelector("#" + n) || t.dynamicLoadResource(function () {
                                            var t = document.createElement("link"),
                                                i, u, f;
                                            if (t.id = n, t.rel = "stylesheet", r && r.length > 0)
                                                for (i = 0, u = r; i < u.length; i++) f = u[i], t.setAttribute(f.name, f.value);
                                            return t
                                        }, function (n) {
                                            n.href = i
                                        }).then(), Promise.resolve("loaded")
                                    };
                                    t.dynamicLoadResource = function (n, t) {
                                        return new Promise(function (r, u) {
                                            var f = n(),
                                                e;
                                            null !== f ? (e = !1, f.setAttribute("data-loaded", "loading"), f.addEventListener("load", function () {
                                                i(f.id, {
                                                    name: "data-loaded",
                                                    value: "true"
                                                });
                                                e = !0;
                                                r("loaded")
                                            }), f.addEventListener("error", function (n) {
                                                i(f.id, {
                                                    name: "data-loaded",
                                                    value: "error"
                                                });
                                                ...
                                                e || (console.warn("timeout(30s) when loading resource, resource id: " + f.id), r("timeout"))
                                            }, 3e4), document.head.appendChild(f)) : r("nothing to load")
                                        })
                                    };
                                    var i = function (n) {
                                        for (var f, i, e, r, o, s, u = [], t = 1; t < arguments.length; t++) u[t - 1] = arguments[t];
                                        for (f = Array.from(document.querySelectorAll("#" + n)), i = 0; i < f.length; i++)
                                            if (e = f[i], i > 0) e.remove();
                                            else
                                                for (r = 0, o = u; r < o.length; r++) s = o[r], e.setAttribute(s.name, s.value)
                                    }
                                },
                                89: (n, t) => {
                                    Object.defineProperty(t, "__esModule", {
                                        value: !0
                                    }), t.cnblogsCodeHighlightAdapterOptions = t.defaultCodeHighlightAdapterOptions = void 0, t.defaultCodeHighlightAdapterOptions = {
                                        enableCodeLineNumber: !0,
                                        prism: {
                                            highlighterScriptPath: "/prism.min.js",
                                        ...
                                        hljs: {
                                            highlighterScriptPath: "/highlight.min.js",
                                            lineNumberPluginPath: "/highlightjs-line-numbers.min.js",
                                            stylesheets: [],
                                            themeBaseUrl: "",
                                            defaultTheme: ""
                                        }
                                    }, t.cnblogsCodeHighlightAdapterOptions = {
                                        enableCodeLineNumber: !1,
                                        prism: {
                                            highlighterScriptPath: "https://common.cnblogs.com/prism/prism.js?v=1.23.0",
                                            lineNumberPluginPath: "https://common.cnblogs.com/prism/plugins/line-numbers/prism-line-numbers.min.js",
                                            autoLoaderPluginPath: "https://common.cnblogs.com/prism/plugins/autoloader/prism-autoloader.min.js",
                                            lineNumberStylePath: "https://common.cnblogs.com/prism/plugins/line-numbers/prism-line-numbers.css",
                                            themeBaseUrl: "https://www.cnblogs.com/css/prismjs",
                                            defaultTheme: "prism-vs",
                                            stylesheets: []
                                        },
                                        hljs: {
                                            highlighterScriptPath: "https://common.cnblogs.com/highlight/10.3.1/highlight.min.js",
                                            lineNumberPluginPath: "https://common.cnblogs.com/scripts/highlightjs-line-numbers.min.js",
                                            stylesheets: [],
                                            themeBaseUrl: "https://www.cnblogs.com/css/hljs",
            ...
            257: function (n, t, i) {
                ...
                n.exports = function (n) {
                    var t = n.findIndex;
                    return n === r || u(r, n) && t === r.findIndex ? f : t
                }
            },
            4863: function (n, t, i) {
                var u = i(2583),
            ...
            5739: function (n, t, i) {
                var u = i(7386),
                    ...
                    s = /^[+-]?0x/i,
                    v = c(s.exec),
                    y = 8 !== r(f + "08") || 22 !== r(f + "0x16") || o && !h(function () {
                        r(Object(o))
                    });
                n.exports = y ? function (n, t) {
                    var i = a(l(n));
                    return r(i, t >>> 0 || (v(s, i) ? 16 : 10))
                } : r
            },
            1007: function (n, t, i) {
                "use strict";
            ...
            3761: function (n, t, i) {
                ...
                var f = i(4218),
                    ...
                    r = "findIndex",
                    u = !0;
                r in [] && Array(1).findIndex(function () {
                    u = !1
                });
                f({
                    target: "Array",
            ...
            7588: function (n) {
                var t = function (n) {
                    ...
                    function tt(n, t, r, u) {
                        var e = t && t.prototype instanceof b ? t : b,
                        ...
                        return f._invoke = function (n, t, r) {
                            ...
                            return function (f, e) {
                                ...
                                for (r.method = f, r.arg = e;;) {
                                    ...
                                    if (u = rt, o = w(n, t, r), "normal" === o.type) {
                                        if (u = r.done ? h : st, o.arg === i) continue;
                                        return {
                                            value: o.arg,
                                            done: r.done
                                        }
                    ...
                    function v(n, t) {
                        function i(r, f, e, o) {
                            var c = w(n[r], n, f),
                                h, s;
                            if ("throw" !== c.type) return h = c.arg, s = h.value, s && "object" == typeof s && u.call(s, "__await") ? t.resolve(s.__await).then(function (n) {
                                i("next", n, e, o)
                            }, function (n) {
                                i("throw", n, e, o)
                    ...
                    function ft(n, t) {
                        ...
                        if (e === r) {
                            if (t.delegate = null, "throw" === t.method) {
                                if (n.iterator.return && (t.method = "return", t.arg = r, ft(n, t), "throw" === t.method)) return i;
                                t.method = "throw";
                                t.arg = new TypeError("The iterator does not provide a 'throw' method")
                            }
                            return i
                        }
                        return (f = w(e, n.iterator, t.arg), "throw" === f.type) ? (t.method = "throw", t.arg = f.arg, t.delegate = null, i) : (u = f.arg, u ? u.done ? (t[n.resultName] = u.value, t.next = n.nextLoc, "return" !== t.method && (t.method = "next", t.arg = r), t.delegate = null, i) : u : (t.method = "throw", t.arg = new TypeError("iterator result is not an object"), t.delegate = null, i))
                    }
                    ...
                    function g(n) {
                        var f, i, e;
                        if (n) {
                            if (f = n[s], f) return f.call(n);
                            if ("function" == typeof n.next) return n;
                            if (!isNaN(n.length)) return i = -1, e = function t() {
                                for (; ++i < n.length;)
                                    if (u.call(n, i)) return t.value = n[i], t.done = !1, t;
                    ...
                    var it = "suspendedStart",
                        ...
                        h = "completed",
                        i = {};
                    return l = {}, t(l, s, function () {
                        return this
                    }), a = Object.getPrototypeOf, o = a && a(a(g([]))), o && o !== nt && u.call(o, s) && (l = o), e = f.prototype = b.prototype = Object.create(l), c.prototype = f, t(e, "constructor", f), t(f, "constructor", c), c.displayName = t(f, p, "GeneratorFunction"), n.isGeneratorFunction = function (n) {
                        var t = "function" == typeof n && n.constructor;
                        return !!t && (t === c || "GeneratorFunction" === (t.displayName || t.name))
                    }, n.mark = function (n) {
                        return Object.setPrototypeOf ? Object.setPrototypeOf(n, f) : (n.__proto__ = f, t(n, p, "GeneratorFunction")), n.prototype = Object.create(e), n
                    }, n.awrap = function (n) {
                        return {
                            __await: n
                        }
                    }, ut(v.prototype), t(v.prototype, ot, function () {
                        return this
                    ...
                    }, ut(e), t(e, p, "Generator"), t(e, s, function () {
                        return this
                    }), t(e, "toString", function () {
                        ...
                        constructor: d,
                        reset: function (n) {
                            if (this.prev = 0, this.next = 0, this.sent = this._sent = r, this.done = !1, this.delegate = null, this.method = "next", this.arg = r, this.tryEntries.forEach(k), !n)
                                for (var t in this) "t" === t.charAt(0) && u.call(this, t) && !isNaN(+t.slice(1)) && (this[t] = r)
                        },
                        stop: function () {
                            this.done = !0;
                        ...
                        dispatchException: function (n) {
                            function i(t, i) {
                                return o.type = "throw", o.arg = n, f.next = t, i && (f.method = "next", f.arg = r), !!i
                            }
                            var f, e, t, o, s, h;
                            if (this.done) throw n;
                            for (f = this, e = this.tryEntries.length - 1; e >= 0; --e) {
                                if (t = this.tryEntries[e], o = t.completion, "root" === t.tryLoc) return i("end");
                                if (t.tryLoc <= this.prev)
                                    if (s = u.call(t, "catchLoc"), h = u.call(t, "finallyLoc"), s && h) {
                        ...
                        abrupt: function (n, t) {
                            for (var f, r, o, e = this.tryEntries.length - 1; e >= 0; --e)
                                if (f = this.tryEntries[e], f.tryLoc <= this.prev && u.call(f, "finallyLoc") && this.prev < f.finallyLoc) {
                                    r = f;
                                    break
                        ...
                        finish: function (n) {
                            for (var t, r = this.tryEntries.length - 1; r >= 0; --r)
                                if (t = this.tryEntries[r], t.finallyLoc === n) return this.complete(t.completion, t.afterLoc), k(t), i
                        },
                        "catch": function (n) {
                        ...
                        delegateYield: function (n, t, u) {
                            return this.delegate = {
                                iterator: g(n),
                                resultName: t,
                                nextLoc: u
                            }, "next" === this.method && (this.arg = r), i
                        }
                    }, n
                }(n.exports);
                try {
    ...
    n.o = function (n, t) {
        ...
        function () {
            ...
            function au(n, t) {
                for (var i, r = 0; r < t.length; r++) i = t[r], i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), ar(n, i.key, i)
            }

            function d(n, t, i) {
                return t && au(n.prototype, t), i && au(n, i), ar(n, "prototype", {
                    writable: !1
                }), n
            }
            ...
            function vt(n) {
                return function (n) {
                    ...
                    if (void 0 !== bo && null != ko(n) || null != n["@@iterator"]) return vu(n)
                }(n) || function (n, t) {
                    var r, i;
                    if (n) return "string" == typeof n ? vr(n, t) : (i = go(r = Object.prototype.toString.call(n)).call(r, 8, -1), "Object" === i && n.constructor && (i = n.constructor.name), "Map" === i || "Set" === i ? vu(n) : "Arguments" === i || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i) ? vr(n, t) : void 0)
                }(n) || function () {
            ...
            function yt(n) {
                return n instanceof c(n).Element || n instanceof Element
            }

            function e(n) {
                return n instanceof c(n).HTMLElement || n instanceof HTMLElement
            }

            function yu(n) {
                return "undefined" != typeof ShadowRoot && (n instanceof c(n).ShadowRoot || n instanceof ShadowRoot)
            }
            ...
            function wt(n, t) {
                ...
                var i = n.getBoundingClientRect(),
                    r = 1,
                    u = 1;
                return e(n) && t && (f = n.offsetHeight, o = n.offsetWidth, o > 0 && (r = pt(i.width) / o || 1), f > 0 && (u = pt(i.height) / f || 1)), {
                    width: i.width / r,
                    height: i.height / u,
                    top: i.top / u,
                    right: i.right / r,
            ...
            function pr(n) {
                return wt(ut(n)).left + yr(n).scrollLeft
            }
            ...
            function fs(n, t, i) {
                ...
                var s = e(t),
                    h = e(t) && function (n) {
                        var t = n.getBoundingClientRect(),
                            i = pt(t.width) / n.offsetWidth || 1,
                            r = pt(t.height) / n.offsetHeight || 1;
                        return 1 !== i || 1 !== r
                    }(t),
                    f = ut(t),
                    u = wt(n, h),
                ...
                return (s || !s && !i) && (("body" !== v(t) || wr(f)) && (o = function (n) {
                    return n !== c(n) && e(n) ? function (n) {
                        return {
                            scrollLeft: n.scrollLeft,
                            scrollTop: n.scrollTop
                        }
                    }(n) : yr(n)
                }(t)), e(t) ? ((r = wt(t, !0)).x += t.clientLeft, r.y += t.clientTop) : f && (r.x = pr(f))), {
                    x: u.left + o.scrollLeft - r.x,
                    y: u.top + o.scrollTop - r.y,
                    width: u.width,
                    height: u.height
                }
            }
            ...
            function di(n) {
                return "html" === v(n) ? n : n.assignedSlot || n.parentNode || (yu(n) ? n.host : null) || ut(n)
            }

            function pu(n) {
                return ["html", "body", "#document"].indexOf(v(n)) >= 0 ? n.ownerDocument.body : e(n) && wr(n) ? n : pu(di(n))
            }
            ...
            function fi(n, t) {
                ...
                var i = pu(n),
                    ...
                    f = c(i),
                    e = u ? [f].concat(f.visualViewport || [], wr(i) ? i : []) : i,
                    o = t.concat(e);
                return u ? o : o.concat(fi(di(e)))
            }
            ...
            function wu(n) {
                return e(n) && "fixed" !== nt(n).position ? n.offsetParent : null
            }

            function ei(n) {
                for (var i = c(n), t = wu(n); t && es(t) && "static" === nt(t).position;) t = wu(t);
                return t && ("html" === v(t) || "body" === v(t) && "static" === nt(t).position) ? i : t || function (n) {
                    var r = -1 !== navigator.userAgent.toLowerCase().indexOf("firefox"),
                        i, t;
                    if (-1 !== navigator.userAgent.indexOf("Trident") && e(n) && "fixed" === nt(n).position) return null;
                    for (i = di(n); e(i) && ["html", "body"].indexOf(v(i)) < 0;) {
                        if (t = nt(i), "none" !== t.transform || "none" !== t.perspective || "paint" === t.contain || -1 !== ["transform", "perspective"].indexOf(t.willChange) || r && "filter" === t.willChange || r && t.filter && "none" !== t.filter) return i;
                        i = i.parentNode
                    }
                    return null
                }(n) || i
            ...
            function hs(n) {
                ...
                return function (n, i, r) {
                        ...
                        e = {
                            ...
                            setOptions: function (r) {
                                ...
                                return l(), u.options = Object.assign({}, t, u.options, h), u.scrollParents = {
                                        reference: yt(n) ? fi(n) : n.contextElement ? fi(n.contextElement) : [],
                                        popper: fi(i)
                                    }, o = function (n) {
                                        var t = ss(n);
                                        return os.reduce(function (n, i) {
                            ...
                            forceUpdate: function () {
                                ...
                                if (!h) {
                                    ...
                                    if (nf(f, t))
                                        for (u.rects = {
                                                reference: fs(f, ei(t), "fixed" === u.options.strategy),
                                                popper: br(t)
                    ...
                    return nf(n, i) ? (e.setOptions(r).then(function (n) {
            ...
            function rf(n) {
                ...
                t = ht.x;
                i = ht.y;
                var ct = a.hasOwnProperty("x"),
                    lt = a.hasOwnProperty("y"),
                    b = u,
                    k = r,
                    h = window;
                if (ft) {
                    var e = ei(y),
                        at = "clientHeight",
                        vt = "clientWidth";
                    (e === c(y) && "static" !== nt(e = ut(y)).position && "absolute" === rt && (at = "scrollHeight", vt = "scrollWidth"), e = e, f === r || (f === u || f === s) && it === si) && (k = o, i -= (et && h.visualViewport ? h.visualViewport.height : e[at]) - tt.height, i *= p ? 1 : -1);
                    (f === u || (f === r || f === o) && it === si) && (b = s, t -= (et && h.visualViewport ? h.visualViewport.width : e[vt]) - tt.width, t *= p ? 1 : -1)
                }
                return d = Object.assign({
                    position: rt
                }, ft && cs), g = !0 === w ? function (n) {
                    var i = n.x,
                        r = n.y,
                    ...
                    x: t,
                    y: i
                }, t = g.x, i = g.y, p ? Object.assign({}, d, ((v = {})[k] = lt ? "0" : "", v[b] = ct ? "0" : "", v.transform = (h.devicePixelRatio || 1) <= 1 ? "translate(" + t + "px, " + i + "px)" : "translate3d(" + t + "px, " + i + "px, 0)", v)) : Object.assign({}, d, ((l = {})[k] = lt ? i + "px" : "", l[b] = ct ? t + "px" : "", l.transform = "", l))
            }
            ...
            function of (n, t) {
                return t === bu ? gr(function (n) {
                    ...
                    var r, i = ut(n),
                        ...
                        f = ht(i.scrollWidth, i.clientWidth, t ? t.scrollWidth : 0, t ? t.clientWidth : 0),
                        o = ht(i.scrollHeight, i.clientHeight, t ? t.scrollHeight : 0, t ? t.clientHeight : 0),
                        e = -u.scrollLeft + pr(n),
                        s = -u.scrollTop;
                    return "rtl" === nt(t || i).direction && (e += ht(i.clientWidth, t ? t.clientWidth : 0) - f), {
                        width: f,
                        height: o,
                        x: e,
                        y: s
            ...
            function ys(n, t, i) {
                var f = "clippingParents" === t ? function (n) {
                        var i = fi(di(n)),
                            t = ["absolute", "fixed"].indexOf(nt(n).position) >= 0 && e(n) ? ei(n) : n;
                        return yt(t) ? i.filter(function (n) {
                            return yt(n) && ef(n, t) && "body" !== v(n)
                        }) : []
                    }(n) : [].concat(t),
                    u = [].concat(f, [i]),
                    o = u[0],
                    r = u.reduce(function (t, i) {
                        var r = of (n, i);
                        return t.top = ht(r.top, t.top), t.right = ki(r.right, t.right), t.bottom = ki(r.bottom, t.bottom), t.left = ht(r.left, t.left), t
                    }, of (n, o));
            ...
            function ci(n, t) {
                ...
                var i = t,
                    ...
                    d = i.padding,
                    c = void 0 === d ? 0 : d,
                    f = sf("number" != typeof c ? c : hf(c, oi)),
                    ot = u === hi ? "reference" : hi,
                    g = n.rects.popper,
                    l = n.elements[et ? ot : u],
                    e = ys(yt(l) ? l : l.contextElement || ut(n.elements.popper), rt, ft),
                    nt = wt(n.elements.reference),
                    st = tf({
                        reference: nt,
                        element: g,
                        strategy: "absolute",
                    ...
                    ht = gr(Object.assign({}, g, st)),
                    h = u === hi ? ht : nt,
                    a = {
                        top: e.top - h.top + f.top,
                        bottom: h.bottom - e.bottom + f.bottom,
                        left: e.left - h.left + f.left,
                        right: h.right - e.right + f.right
                    },
                    tt = n.modifiersData.offset;
                return u === hi && tt && (it = tt[y], Object.keys(a).forEach(function (n) {
                    var t = [s, o].indexOf(n) >= 0 ? 1 : -1,
                        i = [r, o].indexOf(n) >= 0 ? "y" : "x";
                    a[n] += it[i] * t
                })), a
            }
            ...
            function lf(n) {
                return [r, s, o, u].some(function (t) {
                    return n[t] >= 0
                })
            }
            ...
            function nh(n) {
                return ir(n) ? [n] : function (n) {
                    return tu(n, "NodeList")
                }(n) ? tr(n) : Array.isArray(n) ? n : tr(document.querySelectorAll(n))
            }
            ...
            function ih() {
                p.isTouch || (p.isTouch = !0, window.performance && document.addEventListener("mousemove", re))
            }

            function re() {
                var n = performance.now();
                n - ie < 20 && (p.isTouch = !1, document.removeEventListener("mousemove", re));
                ie = n
            }
            ...
            function rh() {
                var n = document.activeElement,
                    t;
                gf(n) && (t = n._tippy, n.blur && !t.state.isVisible && n.blur())
            }
            ...
            function ue(n) {
                var t = (n.plugins || []).reduce(function (t, i) {
                    var u, r = i.name,
                        f = i.defaultValue;
                    return r && (t[r] = void 0 !== n[r] ? n[r] : null != (u = l[r]) ? u : f), t
                }, {});
            ...
            function fe(n, t) {
                var i = Object.assign({}, t, {
                    content: wf(t.content, [n])
                }, t.ignoreAttributes ? {} : function (n, t) {
                    return (t ? Object.keys(ue(Object.assign({}, l, {
                        plugins: t
                    }))) : fh).reduce(function (t, i) {
                ...
                return i.aria = Object.assign({}, l.aria, i.aria), i.aria = {
            ...
            function ee(n) {
                var t = ai();
                return !0 === n ? t.className = vf : (t.className = yf, ir(n) ? t.appendChild(n) : uu(t, n)), t
            }

            function oe(n, t) {
                ir(t.content) ? (uu(n, ""), n.appendChild(t.content)) : "function" != typeof t.content && (t.allowHTML ? uu(n, t.content) : n.textContent = t.content)
            }
            ...
            function fu(n) {
                ...
                return {
                    ...
                    content: t.find(function (n) {
                        return n.classList.contains(af)
                    }),
                    arrow: t.find(function (n) {
                        return n.classList.contains(vf) || n.classList.contains(yf)
                    }),
                    backdrop: t.find(function (n) {
                        return n.classList.contains(ks)
                    })
                }
            }
            ...
            function se(n) {
                function u(t, i) {
                    ...
                    t.content === i.content && t.allowHTML === i.allowHTML || oe(o, n.props);
                    i.arrow ? f ? t.arrow !== i.arrow && (u.removeChild(f), u.appendChild(ee(i.arrow))) : u.appendChild(ee(i.arrow)) : f && u.removeChild(f)
                }
                var r = ai(),
                    t = ai(),
                    i;
                return t.className = "tippy-box", t.setAttribute("data-state", "hidden"), t.setAttribute("tabindex", "-1"), i = ai(), i.className = af, i.setAttribute("data-state", "hidden"), oe(i, n.props), r.appendChild(t), t.appendChild(i), u(n.props, n.props), {
                    popper: r,
                    onUpdate: u
                }
            }
            ...
            function oh(n, t) {
                ...
                function ni(n) {
                    return i.state.isMounted && !i.state.isVisible || p.isTouch || w && "focus" === w.type ? 0 : nu(i.props.delay, n ? 0 : 1, l.delay)
                }
                ...
                function u(n, t, r) {
                    var u;
                    (void 0 === r && (r = !0), wt.forEach(function (i) {
                        i[n] && i[n].apply(i, t)
                ...
                function ti() {
                    var f = i.props.aria,
                        t, u;
                    f.content && (t = "aria-" + f.content, u = r.id, dt(i.props.triggerTarget || n).forEach(function (n) {
                ...
                function y() {
                    !bt && i.props.aria.expanded && dt(i.props.triggerTarget || n).forEach(function (n) {
                ...
                function k(t) {
                    if (!p.isTouch || !nt && "mousedown" !== t.type) {
                        var f = t.composedPath && t.composedPath()[0] || t.target;
                        if (!i.props.interactive || !te(r, f)) {
                            if (dt(i.props.triggerTarget || n).some(function (n) {
                                    return te(n, f)
                                })) {
                                if (p.isTouch) return;
                                if (i.state.isVisible && i.props.trigger.indexOf("click") >= 0) return
                            } else u("onClickOutside", [i, t]);
                            !0 === i.props.hideOnClick && (i.clearDelayTimeouts(), i.hide(), g = !0, setTimeout(function () {
                                g = !1
                ...
                function ui() {
                    ...
                    n.addEventListener("touchend", k, ct);
                    n.addEventListener("touchstart", ri, ct);
                    n.addEventListener("touchmove", ii, ct)
                }

                function ut() {
                    var n = a();
                    n.removeEventListener("mousedown", k, !0);
                    n.removeEventListener("touchend", k, ct);
                    n.removeEventListener("touchstart", ri, ct);
                    n.removeEventListener("touchmove", ii, ct)
                }

                function fi(n, t) {
                    function r(n) {
                        n.target === i && (ru(i, "remove", r), t())
                    }
                    var i = v().box;
                    if (0 === n) return t();
                    ru(i, "remove", ht);
                ...
                function h(t, r, u) {
                    void 0 === u && (u = !1);
                    dt(i.props.triggerTarget || n).forEach(function (n) {
                ...
                function si(n) {
                    var r, t = !1,
                        u;
                    !i.state.isEnabled || vi(n) || g || (u = "focus" === (null == (r = w) ? void 0 : r.type), w = n, at = n.currentTarget, y(), !i.state.isVisible && gs(n) && rr.forEach(function (t) {
                        return t(n)
                    }), "click" === n.type && (i.props.trigger.indexOf("mouseenter") < 0 || c) && !1 !== i.props.hideOnClick && i.state.isVisible ? t = !0 : wi(n), "click" === n.type && (c = !t), t && !u && d(n))
                }
                ...
                function ci(n) {
                    vi(n) || i.props.trigger.indexOf("click") >= 0 && c || (i.props.interactive ? i.hideWithInteractivity(n) : d(n))
                }

                function li(n) {
                    i.props.trigger.indexOf("focusin") < 0 && n.target !== s() || i.props.interactive && n.relatedTarget && r.contains(n.relatedTarget) || d(n)
                }

                function vi(n) {
                    return !!p.isTouch && gt() !== n.type.indexOf("touch") >= 0
                }
                ...
                function yi() {
                    ...
                    var t = i.props,
                        ...
                        p = {
                            ...
                            fn: function (n) {
                                var i = n.state,
                                    t;
                                f() && (t = v().box, ["placement", "reference-hidden", "escaped"].forEach(function (n) {
                    ...
                    i.popperInstance = bs(y, r, Object.assign({}, e, {
                        placement: c,
                        onFirstUpdate: lt,
                        modifiers: u
                    }))
                ...
                function ft() {
                    return tr(r.querySelectorAll("[data-tippy-root]"))
                }
                ...
                var et, ot, st, w, ht, lt, at, e = fe(n, Object.assign({}, l, ue(df(t)))),
                    c = !1,
                    g = !1,
                    nt = !1,
                    tt = !1,
                    it = [],
                    o = bf(hi, e.interactiveDebounce),
                    bi = eh++,
                    vt = function (n) {
                    ...
                    i = {
                        ...
                        setProps: function (t) {
                            if (!i.state.isDestroyed) {
                                ...
                                oi();
                                var f = i.props,
                                    r = fe(n, Object.assign({}, f, df(t), {
                                        ignoreAttributes: !0
                                    }));
                                i.props = r;
                                ei();
                                f.interactiveDebounce !== r.interactiveDebounce && (rt(), o = bf(hi, r.interactiveDebounce));
                                f.triggerTarget && !r.triggerTarget ? dt(f.triggerTarget).forEach(function (n) {
                                    n.removeAttribute("aria-expanded")
                                }) : r.triggerTarget && n.removeAttribute("aria-expanded");
                                y();
                                b();
                                pt && pt(f, r);
                                i.popperInstance && (yi(), ft().forEach(function (n) {
                        ...
                        show: function () {
                            ...
                            var e = i.state.isVisible,
                                ...
                                n = nu(i.props.duration, 0, l.duration);
                            if (!e && !o && !h && !c && !s().hasAttribute("disabled") && (u("onShow", [i], !1), !1 !== i.props.onShow(i))) {
                                if (i.state.isVisible = !0, f() && (r.style.visibility = "visible"), b(), ui(), i.state.isMounted || (r.style.transition = "none"), f()) {
                                    var t = v(),
                                        a = t.box,
                                        w = t.content;
                                    iu([a, w], 0)
                                ...
                                lt = function () {
                                    ...
                                    function () {
                                        var n, t = i.props.appendTo,
                                            u = s();
                                        n = i.props.interactive && t === pf || "parent" === t ? u.parentNode : wf(t, [u]);
                        ...
                        hide: function () {
                            ...
                            var s = !i.state.isVisible,
                                ...
                                a = !i.state.isEnabled,
                                n = nu(i.props.duration, 1, l.duration);
                            if (!s && !h && !a && (u("onHide", [i], !1), !1 !== i.props.onHide(i))) {
                                if (i.state.isVisible = !1, i.state.isShown = !1, tt = !1, c = !1, f() && (r.style.visibility = "hidden"), rt(), ut(), b(!0), f()) {
                                    var t = v(),
                                        e = t.box,
                                        o = t.content;
                                    i.props.animation && (iu([e, o], n), ne([e, o], "hidden"))
                                }
                                ti();
                                y();
                                i.props.animation ? f() && function (n, t) {
                        ...
                        unmount: function () {
                            (i.state.isVisible && i.hide(), i.state.isMounted) && (pi(), ft().forEach(function (n) {
                                n._tippy.unmount()
                            }), r.parentNode && r.parentNode.removeChild(r), ur = ur.filter(function (n) {
                                return n !== i
                            }), i.state.isMounted = !1, u("onHidden", [i]))
                        },
                        destroy: function () {
                            i.state.isDestroyed || (i.clearDelayTimeouts(), i.unmount(), oi(), delete n._tippy, i.state.isDestroyed = !0, u("onDestroy", [i]))
                        }
                    },
                    wt, bt;
                ...
                var yt = e.render(i),
                    r = yt.popper,
                    pt = yt.onUpdate;
                return r.setAttribute("data-tippy-root", ""), r.id = "tippy-" + i.id, i.popper = r, n._tippy = i, r._tippy = i, wt = vt.map(function (n) {
                    return n.fn(i)
                }), bt = n.hasAttribute("aria-expanded"), ei(), y(), b(), u("onCreate", [i]), e.showOnCreate && wi(), r.addEventListener("mouseenter", function () {
                    i.props.interactive && i.state.isVisible && i.clearDelayTimeouts()
                }), r.addEventListener("mouseleave", function () {
                    i.props.interactive && i.props.trigger.indexOf("mouseenter") >= 0 && a().addEventListener("mousemove", o)
                }), i
            }

            function vi(n, t) {
                var r, u, i;
                return void 0 === t && (t = {}), r = l.plugins.concat(t.plugins || []),
                    function () {
                        document.addEventListener("touchstart", ih, ct);
                        window.addEventListener("blur", rh)
                    }(), u = Object.assign({}, t, {
                        plugins: r
                    }), i = nh(n).reduce(function (n, t) {
                        var i = t && oh(t, u);
                        return i && n.push(i), n
                    }, []), ir(n) ? i[0] : i
            }
            ...
            function i(n, t) {
                ...
                let ht, ct, at, p, ut, et, ot, l, a, k, d, r, u, vt, yt, e, o, v, y, pt, wt, bt, kt, dt, ni, st, g, nt, ii;
                ti || function () {
                    w = document.body;
                    w[tt = "requestFullscreen"] || w[tt = "msRequestFullscreen"] || w[tt = "webkitRequestFullscreen"] || w[tt = "mozRequestFullscreen"] || (tt = "");
                    ve = tt && tt.replace("request", "exit").replace("mozRequest", "mozCancel").replace("Request", "Exit");
                ...
                u = u ? f(u, c, a) : e;
                ti = ti || 10;
                this.dom.id = this.id = ht || "winbox-" + ++sh;
                this.dom.className = "winbox" + (nt ? " " + ("string" == typeof nt ? nt : nt.join(" ")) : "") + (pt ? " modal" : "");
                this.x = r;
                this.y = u;
                this.width = l;
                this.height = a;
                ...
                this.onresize = ni;
                this.splitscreen = ii;
                vt ? this.maximize() : this.move().resize();
                ut ? this.mount(ut) : et ? this.body.innerHTML = et : ot && this.setUrl(ot);
                yt ? this.hide() : this.focus();
                this.dom.winbox = this,
                    function (n) {
                        ...
                        rt(n, "se");
                        rt(n, "sw");
                        h(ft(n.dom, "wb-min"), "click", function (t) {
                            lt(t);
                            n.minimize()
                        });
                        h(ft(n.dom, "wb-max"), "click", function (t) {
                            lt(t);
                            n.focus().maximize()
                        });
                        tt ? h(ft(n.dom, "wb-full"), "click", function (t) {
                            lt(t);
                            n.focus().fullscreen()
                        }) : n.addClass("no-full");
                        h(ft(n.dom, "wb-close"), "click", function (t) {
                            lt(t);
                            n.close() || (n = null)
                        });
                        h(n.dom, "click", function () {
                            n.focus()
                        }, !1)
                    }(this);
                (ct || w).appendChild(this.dom)
            }
            ...
            function ou() {
                const i = ni.length,
                    n = {},
                    t = {};
                for (let r, n, u = 0; u < i; u++) r = ni[u], n = r.left + ":" + r.top, t[n] ? t[n]++ : t[n] = 1;
                for (let r, u, f, o, s, e = 0; e < i; e++) r = ni[e], u = r.left + ":" + r.top, f = Math.min((b - r.left - r.right) / t[u], 250), o = ft(r.dom, "wb-title"), s = o.clientHeight, n[u] || (n[u] = 0), r.resize(f + 1 | 0, 0, !0).move(r.left + n[u] * f | 0, it - r.bottom - s, !0), n[u]++
            }

            function rt(n, t) {
                function s(o) {
                    if (lt(o), n.min) n.minimize();
                    else {
                        if ("title" === t && !n.hasClass("no-max")) {
                            const t = Date.now(),
                                i = t - ye;
                            if (ye = t, i < 250) return void n.maximize()
                        }
                        n.max || (le(w, "wb-drag"), (i = o.touches) && (i = i[0]) ? (o = i, h(window, "touchmove", r), h(window, "touchend", u)) : (h(window, "mousemove", r), h(window, "mouseup", u)), f = o.pageX, e = o.pageY, n.focus())
                    }
                }
                ...
                function r(r) {
                    ...
                    (s || h) && (s && (n.width = Math.max(Math.min(n.width, b - n.x - n.right), 150)), h && (n.height = Math.max(Math.min(n.height, it - n.y - n.bottom), 0)), n.resize());
                    (c || l) && (c && (n.x = Math.max(Math.min(n.x, b - n.width - n.right), n.left)), l && (n.y = Math.max(Math.min(n.y, it - n.height - n.bottom), n.top)), n.move());
                    f = a;
                    e = v
                }
                ...
                function u(n) {
                    lt(n);
                    ae(w, "wb-drag");
                    i ? (fr(window, "touchmove", r), fr(window, "touchend", u)) : (fr(window, "mousemove", r), fr(window, "mouseup", u))
                }
                const o = ft(n.dom, "wb-" + t);
                let i, f, e;
                h(o, "mousedown", s);
                h(o, "touchstart", s, {
                    passive: !1
            ...
            function be() {
                if (yi = !1, function () {
                    ...
                    }()) return document[ve](), !0
            }

            function fc() {
                if (null != currentBlogId && currentBlogId >= 0) {
                    var n = {
                        blogId: currentBlogId,
                        postId: "undefined" == typeof cb_entryId ? null : cb_entryId,
                        url: window.location.href,
                        resolution: window.screen.width + "x" + window.screen.height,
                        referrer: document.referrer,
                        createdAt: (new Date).toJSON()
                    };
                    $.ajax("https://analytics.cnblogs.com/api/v1/reports", {
                        type: "POST",
                        data: su()(n),
                        contentType: "application/json; charset=UTF-8",
                        timeout: 5e3,
                        ...
                        success: function (t) {
                            if (n.postId && t && t.reportUrls) {
                                var r, u, i = st()(r = g()(u = vt(document.querySelectorAll("a, link, script"))).call(u, function (n) {
                                        var t;
                                        return null !== (t = n.getAttribute("href")) && void 0 !== t ? t : n.getAttribute("src")
                                    })).call(r, function (n) {
                                        return function (n) {
                                            var r, i, t;
                                            if (!n || n.length >= 4096) return !1;
                                            try {
                                                if ((i = new(tc())(n), !ot()(r = i.protocol.toLowerCase()).call(r, "http")) || (t = i.host.toLowerCase(), bi()(t).call(t, "cnblogs.com") || bi()(t).call(t, "analytics.google.com") || bi()(t).call(t, "localhost")) || /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}$/.test(t)) return !1
                                            } catch (n) {
                                                return !1
                                            }
                                            return !0
                                    ...
                                    f = {
                                        ...
                                        postId: cb_entryId,
                                        createdAt: (new Date).toJSON(),
                                        urlsInPage: i.length > 500 ? uc()(i).call(i, 0, 500) : i
                                    };
                                $.ajax("https://analytics.cnblogs.com/api/v1/reports/urls", {
                                    type: "POST",
                                    data: su()(f),
                                    contentType: "application/json, charset=UTF-8",
                                    timeout: 3e3
            ...
            function no(n, t, i, r, u, f, e) {
                ...
                o.done ? t(s) : ge.resolve(s).then(r, u)
            }
            ...
            function to(n) {
                return function () {
                    var t = this,
                        i = arguments;
                    return new ge(function (r, u) {
                        function f(n) {
                            no(e, r, u, f, o, "next", n)
                        }

                        function o(n) {
                            no(e, r, u, f, o, "throw", n)
                        }
                        var e = n.apply(t, i);
                        f(void 0)
                    })
            ...
            function ho() {
                return (ho = to(hr().mark(function n(t) {
                    return hr().wrap(function (n) {
                        for (;;) switch (n.prev = n.next) {
                            case 0:
                                return t || (t = "#cnblogs_post_body"), ul(function (n, t) {
                                    var f, i, e, r, u;
                                    (fl(n), 2 === codeHighlightEngine && !so()(f = pi()(n.classList)).call(f, function (n) {
                                        return ot()(n).call(n, "language-")
                                    }) && n.className.indexOf("language-") < 0) && (u = null !== (i = so()(e = pi()(null !== (r = t.classList) && void 0 !== r ? r : [])).call(e, function (n) {
                                        return ot()(n).call(n, "language-")
                                    })) && void 0 !== i ? i : "language-none", u && n.classList.add(u))
                                }, t), n.next = 4, rl();
                            case 4:
                                return window.codeHighlightEngine || (window.codeHighlightEngine = 1), n.next = 7, highlighter.highlightAllUnder(t, void 0, function (n) {
            ...
            function co() {
                ...
                t.length && $.each(t, function () {
                    ...
                    t && t.indexOf("brush:") >= 0 && (n = !0, $(this).html().indexOf("<span") >= 0 && $(this).text($(this).text()), t.indexOf("gutter:true;") >= 0 && $(this).parent().addClass("sh-gutter"))
                });
            ...
            var ar = n(2205),
                ...
                po = function () {
                    ...
                    return d(n, [{
                        ...
                        value: function (n) {
                            var t = location.href;
                            return n && t.indexOf("#" + n) < 0 && (t += "#" + n), location.href = ui + "/signin?returnUrl=" + encodeURIComponent(t), !1
                        }
                    }, {
                        key: "logout",
                        value: function () {
                        ...
                        key: "register",
                        value: function () {
                            return location.href = ui + "/signup?returnUrl=" + encodeURIComponent(location.href), !1
                        }
                    }, {
                        key: "getUserInfo",
                        value: function (n) {
                            $.ajax({
                                url: ui + "/user/userinfo",
                                dataType: "html",
                                xhrFields: {
                                    withCredentials: !0
                                },
                        ...
                        value: function (n) {
                            $.ajax({
                                ...
                                success: function (t) {
                                    var i = new(vo())(g()(t).call(t, function (n) {
                                        return n.blogApp
                                    }));
                                    n(i)
                                }
                ...
                bu = "viewport",
                hi = "popper",
                ku = oi.reduce(function (n, t) {
                    return n.concat([t + "-" + bt, t + "-" + si])
                }, []),
                du = [].concat(oi, [kr]).reduce(function (n, t) {
                    return n.concat([t, t + "-" + bt, t + "-" + si])
                }, []),
                os = ["beforeRead", "read", "afterRead", "beforeMain", "main", "afterMain", "beforeWrite", "write", "afterWrite"],
                gu = {
                    placement: "bottom",
                    modifiers: [],
                    strategy: "absolute"
                    ...
                    fn: function (n) {
                        ...
                        Object.keys(t.elements).forEach(function (n) {
                            var u = t.styles[n] || {},
                                r = t.attributes[n] || {},
                                i = t.elements[n];
                            e(i) && v(i) && (Object.assign(i.style, u), Object.keys(r).forEach(function (n) {
                                var t = r[n];
                        ...
                        return Object.assign(t.elements.popper.style, i.popper), t.styles = i, t.elements.arrow && Object.assign(t.elements.arrow.style, i.arrow),
                            function () {
                                Object.keys(t.elements).forEach(function (n) {
                                    var r = t.elements[n],
                                        u = t.attributes[n] || {},
                                        f = Object.keys(t.styles.hasOwnProperty(n) ? t.styles[n] : i[n]).reduce(function (n, t) {
                                            return n[t] = "", n
                                        }, {});
                                    e(r) && v(r) && (Object.assign(r.style, f), Object.keys(u).forEach(function (n) {
                                        r.removeAttribute(n)
                                    }))
                                })
                            }
                ...
                ls = {
                    ...
                    fn: function (n) {
                        var t = n.state,
                            ...
                            i = o.offset,
                            c = void 0 === i ? [0, 0] : i,
                            f = du.reduce(function (n, i) {
                                return n[i] = function (n, t, i) {
                                    var o = y(n),
                                        c = [u, r].indexOf(o) >= 0 ? -1 : 1,
                                        h = "function" == typeof i ? i(Object.assign({}, t, {
                                            placement: n
                                        })) : i,
                                        f = h[0],
                                        e = h[1];
                                    return f = f || 0, e = (e || 0) * c, [u, s].indexOf(o) >= 0 ? {
                                        x: e,
                                        y: f
                                    } : {
                                        x: f,
                            ...
                            l = e.x,
                            a = e.y;
                        null != t.modifiersData.popperOffsets && (t.modifiersData.popperOffsets.x += l, t.modifiersData.popperOffsets.y += a);
                        t.modifiersData[h] = f
                    }
                },
                as = {
                ...
                ps = {
                    ...
                    fn: function (n) {
                        var t = n.state,
                            ...
                            c = t.rects.reference,
                            b = t.rects.popper,
                            d = "function" == typeof it ? it(Object.assign({}, t.rects, {
                        ...
                        if (w) {
                            if (di) {
                                var yt, pt = "y" === i ? r : u,
                                    ...
                                    ii = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : {
                                        top: 0,
                                        right: 0,
                                        bottom: 0,
                                        left: 0
                                    ...
                                    ui = ii[wt],
                                    nt = li(0, c[f], er[f]),
                                    or = vt ? c[f] / 2 - ni - nt - ri - a.mainAxis : ur - nt - ri - a.mainAxis,
                                    sr = vt ? -c[f] / 2 + ni + nt + ui + a.mainAxis : fr + nt + ui + a.mainAxis,
                                    ft = t.elements.arrow && ei(t.elements.arrow),
                                    hr = ft ? "y" === i ? ft.clientTop || 0 : ft.clientLeft || 0 : 0,
                                    fi = null != (yt = null == g ? void 0 : g[i]) ? yt : 0,
                                    cr = v + sr - fi,
                                    oi = li(h ? ki(dt, v + or - fi - hr) : dt, v, h ? ht(gt, cr) : gt);
                                w[i] = oi;
                                ut[i] = oi - v
                            }
                            if (gi) {
                                var si, lr = "x" === i ? r : u,
                                    ...
                                    ai = l - k[ar],
                                    et = -1 !== [r, u].indexOf(at),
                                    vi = null != (si = null == g ? void 0 : g[p]) ? si : 0,
                                    yi = et ? hi : l - c[tt] - b[tt] - vi + a.altAxis,
                                    pi = et ? l + c[tt] + b[tt] - vi - a.altAxis : ai,
                                    wi = h && et ? function (n, t, i) {
                                        var r = li(n, t, i);
                                        return r > i ? i : r
                                    }(yi, l, pi) : li(h ? yi : hi, l, h ? pi : ai);
                                w[p] = wi;
                                ut[p] = wi - l
                            }
                ...
                ws = {
                    ...
                    fn: function (n) {
                        var e, t = n.state,
                            ...
                            a = y(t.placement),
                            i = dr(a),
                            f = [u, s].indexOf(a) >= 0 ? "height" : "width";
                        if (h && c) {
                            var v = function (n, t) {
                                    return sf("number" != typeof (n = "function" == typeof n ? n(Object.assign({}, t.rects, {
                                        placement: t.placement
                                    })) : n) ? n : hf(n, oi))
                                }(g.padding, t),
                                p = br(h),
                                nt = "y" === i ? r : u,
                                tt = "y" === i ? o : s,
                                it = t.rects.reference[f] + t.rects.reference[i] - c[i] - t.rects.popper[f],
                                rt = c[i] - t.rects.reference[i],
                                l = ei(h),
                                w = l ? "y" === i ? l.clientHeight || 0 : l.clientWidth || 0 : 0,
                                ut = it / 2 - rt / 2,
                                ft = v[nt],
                                et = w - p[f] - v[tt],
                                b = w / 2 - p[f] / 2 + ut,
                                k = li(ft, b, et),
                                ot = i;
                            t.modifiersData[d] = ((e = {})[ot] = k, e.centerOffset = k - b, e)
                        }
                    },
                    effect: function (n) {
                        var i = n.state,
                        ...
                        null != t && ("string" != typeof t || (t = i.elements.popper.querySelector(t))) && ef(i.elements.popper, t) && (i.elements.arrow = t)
                    },
                    requires: ["popperOffsets"],
                    ...
                    defaultModifiers: [{
                        ...
                        effect: function (n) {
                            var i = n.state,
                                ...
                                e = r.resize,
                                o = void 0 === e || e,
                                s = c(i.elements.popper),
                                h = [].concat(i.scrollParents.reference, i.scrollParents.popper);
                            return f && h.forEach(function (n) {
                                    n.addEventListener("scroll", t.update, gi)
                                }), o && s.addEventListener("resize", t.update, gi),
                                function () {
                                    f && h.forEach(function (n) {
                                        n.removeEventListener("scroll", t.update, gi)
                                    });
                                    o && s.removeEventListener("resize", t.update, gi)
                                }
                        },
                        data: {}
                    }, {
                        ...
                        fn: function (n) {
                            ...
                            null != t.modifiersData.popperOffsets && (t.styles.popper = Object.assign({}, t.styles.popper, rf(Object.assign({}, o, {
                                offsets: t.modifiersData.popperOffsets,
                                position: t.options.strategy,
                                adaptive: h,
                                roundOffsets: e
                            }))));
                            null != t.modifiersData.arrow && (t.styles.arrow = Object.assign({}, t.styles.arrow, rf(Object.assign({}, o, {
                        ...
                        fn: function (n) {
                            ...
                            if (!t.modifiersData[k]._skip) {
                                for (var d = i.mainAxis, at = void 0 === d || d, g = i.altAxis, vt = void 0 === g || g, yt = i.fallbackPlacements, nt = i.padding, tt = i.boundary, it = i.rootBoundary, pt = i.altBoundary, rt = i.flipVariations, p = void 0 === rt || rt, wt = i.allowedAutoPlacements, f = t.options.placement, dt = y(f), gt = yt || (dt === f || !p ? [nr(f)] : function (n) {
                                        if (y(n) === kr) return [];
                                        var t = nr(n);
                                        return [ff(n), t, ff(t)]
                                    }(f)), c = [f].concat(gt).reduce(function (n, i) {
                                        return n.concat(y(i) === kr ? function (n, t) {
                                            var r;
                                            void 0 === t && (t = {});
                                            var i = t,
                                                s = i.placement,
                                    ...
                                    }, []), ni = t.rects.reference, ti = t.rects.popper, ut = new Map, ft = !0, l = c[0], w = 0; w < c.length; w++) {
                                    var e = c[w],
                                        et = y(e),
                                        ot = kt(e) === bt,
                                        st = [r, o].indexOf(et) >= 0,
                                        ...
                                        a = st ? ot ? s : u : ot ? o : r;
                                    if (ni[ht] > ti[ht] && (a = nr(a)), ct = nr(a), h = [], at && h.push(b[et] <= 0), vt && h.push(b[a] <= 0, b[ct] <= 0), h.every(function (n) {
                                            return n
                                        })) {
                                        l = e;
                                        ft = !1;
                                ...
                                if (ft)
                                    for (lt = function (n) {
                                        ...
                                        if ("break" === lt(v)) break;
                                t.placement !== l && (t.modifiersData[k]._skip = !0, t.placement = l, t.reset = !0)
                            }
                        },
                        requiresIfExists: ["offset"],
                        data: {
                ...
                ie = 0,
                uh = !!("undefined" != typeof window && "undefined" != typeof document) && !!window.msCrypto,
                l = Object.assign({
                    appendTo: pf,
                    aria: {
                        content: "auto",
            ...
            eu = function (n) {
                ...
                ur.forEach(function (n) {
                    var i = !1,
                        u;
                    (t && (i = gf(t) ? n.reference === t : n.popper === t.popper), i) || (u = n.props.duration, n.setProps({
                        duration: r
            ...
            const ni = [];
            let w, ti, yi, et, tt, ve, b, it, sh = 0,
                ye = 0;
            i.new = function (n) {
                return new i(n)
            };
            ...
            i.prototype.setTitle = function (n) {
                ...
                }(ft(this.dom, "wb-title"), this.title = n), this
            };
            i.prototype.setBackground = function (n) {
                return gt(this.dom, "background", n), this
            };
            i.prototype.setUrl = function (n) {
                return this.body.innerHTML = '<iframe src="' + n + '"><\/iframe>', this
            };
            i.prototype.focus = function () {
                return et !== this && (gt(this.dom, "z-index", ti++), this.addClass("focus"), et && (et.removeClass("focus"), et.onblur && et.onblur()), et = this, this.onfocus && this.onfocus()), this
            };
            ...
            i.prototype.minimize = function (n) {
                return yi && be(this), !n && this.min ? (er(this), this.resize().move().focus()) : !1 === n || this.min || (ni.push(this), ou(), this.dom.title = this.title, this.addClass("min"), this.min = !0), this.max && (this.removeClass("max"), this.max = !1), this
            };
            i.prototype.maximize = function (n) {
                return void 0 !== n && n === this.max || (this.min && er(this), (this.max = !this.max) ? this.addClass("max").resize(b - this.left - this.right, it - this.top - this.bottom, !0).move(this.left, this.top, !0) : this.resize().move().removeClass("max")), this
            };
            i.prototype.fullscreen = function (n) {
                return void 0 !== n && n === yi || (this.min && (this.resize().move(), er(this)), yi && be(this) || (this.body[tt](), yi = !0)), this
            };
            ...
            i.prototype.move = function (n, t, i) {
                return n || 0 === n ? i || (this.x = n ? n = f(n, b - this.left - this.right, this.width) : 0, this.y = t ? t = f(t, it - this.top - this.bottom, this.height) : 0) : (n = this.x, t = this.y, this.splitscreen && (0 === n || n === b - this.width) && this.resize(b / 2, it)), gt(this.dom, "transform", "translate(" + n + "px," + t + "px)"), this.onmove && this.onmove(n, t), this
            };
            i.prototype.resize = function (n, t, i) {
                return n || 0 === n ? i || (this.width = n ? n = f(n, b - this.left - this.right) : 0, this.height = t ? t = f(t, it - this.top - this.bottom) : 0) : (n = this.width, t = this.height), n = Math.max(n, this.minwidth), t = Math.max(t, this.minheight), gt(this.dom, "width", n + "px"), gt(this.dom, "height", t + "px"), this.onresize && this.onresize(n, t), this
            };
            i.prototype.addClass = function (n) {
                return le(this.dom, n), this
            };
            i.prototype.removeClass = function (n) {
                return ae(this.dom, n), this
            };
            ...
            var hh = function () {
                    function n() {
                        ...
                        t(this, "onTippyShown", function (n) {
                            ...
                            i.height = n.popper.clientHeight;
                            i.width = n.popper.clientWidth
                        });
                        t(this, "onTippyHidden", function (n) {
                            n.reference.classList.remove("active")
                        });
                        t(this, "pinNavigator", function (n) {
                            var t, r;
                            i.toc && (r = n, i.pinnedNavigator = new pe("目录导航", {
                                index: 9999,
                                background: "var(--cnblogs-toc-bg-color)",
                                "class": ["cnblogs-toc-pinned-navigator", "no-max", "no-min", "no-full"],
                                border: "0",
                                x: r.clientX + "px",
                                y: r.clientY + "px",
                                width: i.width + "px",
                                height: (null !== (t = i.height) && void 0 !== t ? t : 300) + 35 + "px",
                                mount: $(n.target).parent().parent().get()[0],
                                onclose: i.closePinnedNavigator
                            }), eu(), i.tippyInstances.forEach(function (n) {
                    ...
                    return d(n, [{
                        ...
                        value: function () {
                            var w, b, k, d, r = this,
                                v, y, u, nt, f, e, h, i, o, l, a;
                            if (this.enabled && (y = document.querySelector("#cnblogs_post_body"), y && !((v = vt(y.querySelectorAll("h1, h2, h3, h4, h5, h6"))).length <= 1) && (u = document.getElementById("cb_post_title_url"), u))) {
                                var n = [],
                                    s = [],
                                    t = document.createElement("div");
                                t.className = "cnblogs-toc";
                                nt = wi()(w = u.innerText).call(w);
                                f = document.createElement("button");
                                f.classList.add("cnblogs-toc-button");
                                f.title = "显示目录导航";
                                $(f).insertAfter(u);
                                s.push(f);
                                e = document.createElement("div");
                                e.className = "cnblogs-toc-title";
                                e.innerHTML = "<div>目录导航<\/div>";
                                h = document.createElement("button");
                                h.classList.add("cnblogs-toc-pinned-button");
                                $(h).on("click", this.pinNavigator);
                                e.appendChild(h);
                                t.appendChild(e);
                                i = document.createElement("div");
                                i.className = "cnblogs-toc-item";
                                i.setAttribute("data-level", "0");
                                i.innerText = nt;
                                $(i).on("click", function () {
                                    u.scrollIntoView({
                                        behavior: "smooth"
                                ...
                                t.appendChild(i);
                                for (var c = g()(b = st()(k = g()(v).call(v, function (n) {
                                        return n
                                    })).call(k, function (n) {
                                        var t;
                                        return n.innerText && wi()(t = n.innerText).call(t)
                                    })).call(b, function (n) {
                                        return {
                                            heading: n,
                                            tocItem: r.generateTocItem(n)
                                        }
                                    }), tt = function (i) {
                                        var r = c[i],
                                            u;
                                        if (0 == n.length || n[n.length - 1].heading.tagName < r.heading.tagName) t.appendChild(r.tocItem), n.push(r), r.tocItem.setAttribute("data-level", n.length.toString());
                                        else if (n[n.length - 1].heading.tagName >= r.heading.tagName) {
                                            for (; n.length > 0 && n[n.length - 1].heading.tagName >= r.heading.tagName;) n.pop();
                                            t.appendChild(r.tocItem);
                                            n.push(r);
                                            r.tocItem.setAttribute("data-level", n.length.toString())
                                        }
                                        u = document.createElement("button");
                                        u.classList.add("cnblogs-toc-button");
                                        u.title = "显示目录导航";
                                        s.push(u);
                                        r.heading.appendChild(u);
                                        $(r.tocItem).on("click", function () {
                                            r.heading.scrollIntoView({
                                                behavior: "smooth"
                                            });
                                            eu()
                                        })
                                    }, p = 0; p < c.length; p++) tt(p);
                                st()(d = g()(c).call(c, function (n) {
                                    return n.tocItem
                                })).call(d, function (n) {
                                    var t, i;
                                    ...
                                    t.className = "cnblogs-toc-collapse-button";
                                    $(t).on("click", r.onToggleCollapse);
                                    $(t).prependTo(n)
                                });
                                o = document.createElement("div");
                                o.className = "cnblogs-toc-bottom-toolbar";
                                l = document.createElement("span");
                                (l.className = "cnblogs-toc-publish-date", l.innerText = "发布于 " + window.currentPostDateAdded, o.appendChild(l), this.displayDisableTocTips) && (a = document.createElement("div"), a.className = "cnblogs-toc-tips", a.innerHTML = "<a href='https://i.cnblogs.com/preference' target='_blank' title='前往博客后台'>关闭目录导航<\/a>", o.appendChild(a));
                                t.appendChild(o);
                                this.toc = t;
                                this.tippyInstances = g()(s).call(s, function (n) {
                                    return he(n, {
                                        content: function () {
                                            return $(r.toc).clone(!0, !0).get()[0]
                                        },
                                        arrow: !1,
                                        placement: "auto",
                                        trigger: "click",
                                        ...
                                        hideOnClick: !0,
                                        allowHTML: !0,
                                        onShown: r.onTippyShown,
                                        onHidden: r.onTippyHidden
                                    })
                                })
                            }
                        }
                        ...
                        value: function (n) {
                            var r, u, t = document.createElement("div"),
                                i = document.createElement("div");
                            return t.className = "cnblogs-toc-item", i.className = "cnblogs-toc-content", i.innerText = wi()(r = n.innerText).call(r), t.title = wi()(u = n.innerText).call(u), t.appendChild(i), t
                        }
                    }, {
                        key: "onToggleCollapse",
                        value: function () {
                            var i, r, t = $(this).parent();
                            t.toggleClass("cnblogs-toc-collapsed");
                            var e = t.hasClass("cnblogs-toc-collapsed"),
                                ...
                                n = u(t),
                                f = rs()(i = st()(r = $(n)).call(r, ".cnblogs-toc-collapsed").get()).call(i, function (n) {
                                    return u($(n))
                                });
                            return n = st()(n).call(n, function (n) {
                                return !bi()(f).call(f, n)
                ...
                vh = function () {
                    function n() {
                        k(this, n);
                        t(this, "_overflow", "");
                        t(this, "_timer", void 0)
                    }
                    return d(n, [{
                        key: "isDev",
                        get: function () {
                            var n = window.location.host;
                            return !(ot()(n).call(n, "www.cnblogs.com") || ot()(n).call(n, "cnblogs.com") || "production" === localStorage.getItem("environment"))
                        }
                    }, {
                        key: "modalEl",
                        get: function () {
                            return document.querySelector(".cnblogs-overlay-report .cnblogs-report-modal")
                        }
                    }, {
                        key: "iframeEl",
                        get: function () {
                            return document.querySelector(".cnblogs-overlay-report .cnblogs-report-modal iframe")
                        }
                    }, {
                        key: "overlayEl",
                        get: function () {
                            return document.querySelector(".cnblogs-overlay-report")
                        }
                    }, {
                        key: "report",
                        value: function (n) {
                            var t = this,
                                i;
                            isLogined ? (this.forbidScroll(), document.domain = "cnblogs.com", this.buildModal(), window.cnblogsReportConfig = ah()({}, n, {
                                close: function () {
                                    t.closeModal()
                                },
                                gotoLoginPage: window.login
                            }), i = document.createElement("iframe"), (i = this.modalEl.insertAdjacentElement("afterbegin", i)).src = this.isDev ? "https://dev-report.cnblogs.com" : "https://report.cnblogs.com", i.onload = function () {
                                t.setFrameHeight();
                        ...
                        key: "closeModal",
                        value: function () {
                            this.overlayEl && (this.overlayEl.remove(), this.enableScroll());
                        ...
                        value: function () {
                            var t = this,
                                n;
                            this.modalEl || (n = document.createElement("div"), n.classList.add("cnblogs-overlay-report"), n.innerHTML = '<div class="cnblogs-report-modal"><\/div>', n.onclick = function () {
                                t.closeModal()
                        ...
                        key: "setFrameHeight",
                        value: function () {
                            var n = Math.max(this.iframeEl.contentDocument.body.clientHeight, this.iframeEl.contentDocument.body.scrollHeight);
                            n != +this.iframeEl.height && (this.iframeEl.height = n.toString())
                        }
                    }]), n
                }(),
                at = Object.assign || function (n) {
                ...
                de = function (n) {
                    try {
                        return Array.isArray(n) ? n.filter(or) : function (n) {
                            return NodeList.prototype.isPrototypeOf(n)
                        }(n) ? [].slice.call(n).filter(or) : sr(n) ? [n].filter(or) : "string" == typeof n ? [].slice.call(document.querySelectorAll(n)).filter(or) : []
                    } catch (n) {
                ...
                ph = function (n) {
                    ...
                    return t.removeAttribute("id"), t.style.position = "absolute", t.style.top = r + o + "px", t.style.left = u + s + "px", t.style.width = f + "px", t.style.height = e + "px", t.style.transform = "", t
                },
                ii = function (n, t) {
                    var i = at({
                            bubbles: !1,
            ...
            var wh = function bh(n) {
                    var y = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                        ...
                        w = function () {
                            if (!e && t.original) {
                                ...
                                Math.abs(v - n) > i.scrollOffset && setTimeout(f, 150)
                            }
                        },
                        b = function (n) {
                            var t = n.key || n.keyCode;
                            "Escape" !== t && "Esc" !== t && 27 !== t || f()
                        },
                        k = function () {
                            var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                                t = n,
                                f;
                            return (n.background && (o.style.background = n.background), n.container && n.container instanceof Object && (t.container = at({}, i.container, n.container)), n.template) && (f = sr(n.template) ? n.template : document.querySelector(n.template), t.template = f), i = at({}, i, t), u.forEach(function (n) {
                                n.dispatchEvent(ii("medium-zoom:update", {
                                    detail: {
                                        zoom: r
                                    }
                                }))
                        ...
                        c = function () {
                            for (var t, i = arguments.length, f = Array(i), n = 0; n < i; n++) f[n] = arguments[n];
                            return t = f.reduce(function (n, t) {
                                return [].concat(n, de(t))
                            }, []), t.filter(function (n) {
                        ...
                        g = function () {
                            for (var e, o = arguments.length, i = Array(o), n = 0; n < o; n++) i[n] = arguments[n];
                            return t.zoomed && f(), e = i.length > 0 ? i.reduce(function (n, t) {
                                return [].concat(n, de(t))
                            }, []) : u, e.forEach(function (n) {
                                n.classList.remove("medium-zoom-image");
                                n.dispatchEvent(ii("medium-zoom:detach", {
                                    detail: {
                                        zoom: r
                                    }
                                }))
                            ...
                            var c = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                                ...
                                s = function () {
                                    var n = {
                                        ...
                                        u = void 0;
                                    if (i.container)
                                        if (i.container instanceof Object) r = (n = at({}, n, i.container)).width - n.left - n.right - 2 * i.margin, u = n.height - n.top - n.bottom - 2 * i.margin;
                                        else {
                                            var e = (sr(i.container) ? i.container : document.querySelector(i.container)).getBoundingClientRect(),
                                                a = e.width,
                                                v = e.height,
                                                y = e.left,
                                                p = e.top;
                                        ...
                                        } r = r || n.width - 2 * i.margin;
                                    u = u || n.height - 2 * i.margin;
                                    var f = t.zoomedHd || t.original,
                                        w = ke(f) ? r : f.naturalWidth || r,
                                        b = ke(f) ? u : f.naturalHeight || u,
                                        ...
                                        nt = Math.min(b, u) / c,
                                        s = Math.min(g, nt),
                                        l = "scale(" + s + ") translate3d(" + ((r - h) / 2 - d + i.margin + n.left) / s + "px, " + ((u - c) / 2 - k + i.margin + n.top) / s + "px, 0)";
                                    t.zoomed.style.transform = l;
                                    t.zoomedHd && (t.zoomedHd.style.transform = l)
                                };
                            return new h(function (h) {
                                var l, a, c, y;
                                if (n && -1 === u.indexOf(n)) h(r);
                                else if (t.zoomed) h(r);
                                else {
                                    if (n) t.original = n;
                                    else {
                                        if (!(u.length > 0)) return void h(r);
                                        l = u;
                                        t.original = l[0]
                                    }(t.original.dispatchEvent(ii("medium-zoom:open", {
                                        detail: {
                                            zoom: r
                                        }
                                    })), v = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0, e = !0, t.zoomed = ph(t.original), document.body.appendChild(o), i.template) && (a = sr(i.template) ? i.template : document.querySelector(i.template), t.template = document.createElement("div"), t.template.appendChild(a.content.cloneNode(!0)), document.body.appendChild(t.template));
                                    (document.body.appendChild(t.zoomed), window.requestAnimationFrame(function () {
                                        document.body.classList.add("medium-zoom--opened")
                                    }), t.original.classList.add("medium-zoom-image--hidden"), t.zoomed.classList.add("medium-zoom-image--opened"), t.zoomed.addEventListener("click", f), t.zoomed.addEventListener("transitionend", function p() {
                                        e = !1;
                                        t.zoomed.removeEventListener("transitionend", p);
                                        t.original.dispatchEvent(ii("medium-zoom:opened", {
                                            detail: {
                                                zoom: r
                                            }
                                        }));
                                        h(r)
                                    }), t.original.getAttribute("data-zoom-src")) ? (t.zoomedHd = t.zoomed.cloneNode(), t.zoomedHd.removeAttribute("srcset"), t.zoomedHd.removeAttribute("sizes"), t.zoomedHd.src = t.zoomed.getAttribute("data-zoom-src"), t.zoomedHd.onerror = function () {
                                        clearInterval(c);
                                        console.warn("Unable to reach the zoom image target " + t.zoomedHd.src);
                                        t.zoomedHd = null;
                                        s()
                                    }, c = setInterval(function () {
                                        t.zoomedHd.complete && (clearInterval(c), t.zoomedHd.classList.add("medium-zoom-image--opened"), t.zoomedHd.addEventListener("click", f), document.body.appendChild(t.zoomedHd), s())
                                    }, 10)) : t.original.hasAttribute("srcset") ? (t.zoomedHd = t.zoomed.cloneNode(), t.zoomedHd.removeAttribute("sizes"), t.zoomedHd.removeAttribute("loading"), y = t.zoomedHd.addEventListener("load", function () {
                                        t.zoomedHd.removeEventListener("load", y);
                                        t.zoomedHd.classList.add("medium-zoom-image--opened");
                                        t.zoomedHd.addEventListener("click", f);
                        ...
                        f = function () {
                            return new h(function (n) {
                                !e && t.original ? (e = !0, document.body.classList.remove("medium-zoom--opened"), t.zoomed.style.transform = "", t.zoomedHd && (t.zoomedHd.style.transform = ""), t.template && (t.template.style.transition = "opacity 150ms", t.template.style.opacity = 0), t.original.dispatchEvent(ii("medium-zoom:close", {
                                    detail: {
                                        zoom: r
                                    }
                                    ...
                                    t.original.dispatchEvent(ii("medium-zoom:closed", {
                                        detail: {
                                            zoom: r
                                        }
                                    }));
                        ...
                        o, r;
                    return "[object Object]" === Object.prototype.toString.call(n) ? i = n : (n || "string" == typeof n) && c(n), i = at({
                        margin: 0,
                        background: "#fff",
                        scrollOffset: 40,
                        container: null,
                        template: null
                    }, i), o = yh(i.background), document.addEventListener("click", p), document.addEventListener("keyup", b), document.addEventListener("scroll", w), window.addEventListener("resize", f), r = {
                        open: l,
                        close: f,
                        toggle: a,
                        update: k,
                ...
                gh = function () {
                    function n() {
                        ...
                        t(this, "enabled", !0);
                        t(this, "minWidth", 300);
                        t(this, "background", "rgba(0, 0, 0, .8)")
                    }
                    return d(n, [{
                        key: "apply",
                        value: function (n) {
                            ...
                            if (this.enabled) {
                                var r = this.minWidth,
                                    ...
                                    e = dh()(f.get()),
                                    i = function (n) {
                                        n.naturalWidth > r && wh(n, {
                                            background: u
                                        })
                                    };
                                e.on("progress", function (n, t) {
                                    var r = null == t ? void 0 : t.img,
                                        u;
                                    r && (0 === r.naturalWidth && 0 === r.naturalHeight && (u = setInterval(function () {
                                        0 !== r.naturalWidth && (clearInterval(u), i(r))
                                    }, 800)), i(r))
                                })
                            }
                        }
            ...
            var ac = n(6708),
                ...
                hu = function () {
                    ...
                    return d(n, null, [{
                        ...
                        value: function (n) {
                            if ("code" !== n.tagName.toLowerCase()) throw Error("Invalid param codeEl, require is a code element");
                            n.querySelectorAll(".hljs-ln-numbers,.line-numbers-rows").forEach(function (n) {
                                return n.remove()
                            });
                            n.querySelectorAll(".hljs-ln-code").forEach(function (n) {
                                return "".concat(n.innerHTML)
                            });
                            n.innerHTML = n.innerHTML
                        }
                    }, {
                        key: "copyCode",
                        value: (t = to(hr().mark(function i(t) {
                            var f, r, u;
                            return hr().wrap(function (i) {
                                for (;;) switch (i.prev = i.next) {
                                    case 0:
                                        if ((r = t.cloneNode(!0)).style.opacity = "0", r.style.height = "0", r.style.whiteSpace = "pre", r.style.margin = "0", document.body.appendChild(r), n.removeLineNumbers(r.querySelector("code")), u = null === (f = r.querySelector("code")) || void 0 === f ? void 0 : f.textContent, r.remove(), !u) {
                                            i.next = 12;
                                            break
                                        }
                                        return i.next = 12, navigator.clipboard.writeText(u);
                                    case 12:
                                        return i.abrupt("return", null != u ? u : "");
                                    case 13:
                                    case "end":
                                        return i.stop()
                                }
                        ...
                        key: "getLanguage",
                        value: function (n) {
                            var s, t, i, r, u, f, e, o = a()(s = []).call(s, vt(n.classList), vt(null !== (t = null === (i = n.querySelector("code")) || void 0 === i ? void 0 : i.classList) && void 0 !== t ? t : [])),
                                h = null !== (r = null === (u = o[vc()(o).call(o, function (n) {
                                    return ot()(n).call(n, "language-")
                                })]) || void 0 === u || null === (f = u.split("language-")[1]) || void 0 === f ? void 0 : f.toLowerCase()) && void 0 !== r ? r : "";
                            return null !== (e = pc[h]) && void 0 !== e ? e : h.toUpperCase()
                        }
                    }]), n
                }(),
                wc = function () {
                    function n() {
                        var i = this;
                        k(this, n);
                        t(this, "_activeEl", void 0);
                        t(this, "_overlayEl", void 0);
                        t(this, "_top", 0);
                        t(this, "_left", 0);
                        t(this, "_width", 0);
                        t(this, "_height", 0);
                        window.addEventListener("keydown", function (n) {
                            "escape" === n.key.toLowerCase() && i.exitFullscreen()
                        })
                    }
                    return d(n, [{
                        key: "isFullscreen",
                        ...
                        value: function (n) {
                            return n.getAttribute("fullscreen") === "".concat(!0)
                        }
                    }, {
                        key: "enterFullscreen",
                        value: function (n) {
                            var t = this;
                            this.exitFullscreen();
                            this._activeEl = n.cloneNode(!0);
                            this._overlayEl = this.createOverlay();
                            this._overlayEl.append(this._activeEl);
                            var i = n.offsetWidth,
                                r = n.offsetHeight,
                                u = function (n) {
                                    for (var u, r, i = n.offsetLeft, t = n.offsetParent; null !== t;) i += t.offsetLeft + t.clientLeft, t = t.offsetParent;
                                    for (u = i - ("BackCompat" == document.compatMode ? document.body.scrollLeft : document.documentElement.scrollLeft), r = n.offsetTop, t = n.offsetParent; null !== t;) r += t.offsetTop + t.clientTop, t = t.offsetParent;
                                    return {
                                        x: u,
                                        y: r - ("BackCompat" == document.compatMode ? document.body.scrollTop : document.documentElement.scrollTop)
                                    }
                                }(n),
                                f = u.x,
                                e = u.y;
                            this._overlayEl.style.left = "".concat(f, "px");
                            this._overlayEl.style.top = "".concat(e, "px");
                            this._overlayEl.style.width = "".concat(i, "px");
                            this._overlayEl.style.height = "".concat(r, "px");
                            this._top = e;
                            this._left = f;
                            this._width = i;
                            this._height = r;
                            document.body.append(this._overlayEl);
                            document.body.classList.add("code-fullscreen-body");
                            this._activeEl.setAttribute("fullscreen", "true");
                            setTimeout(function () {
                                t._overlayEl && (t._overlayEl.style.right = "0", t._overlayEl.style.left = "0", t._overlayEl.style.top = "0", t._overlayEl.style.bottom = "0", t._overlayEl.style.width = "100%", t._overlayEl.style.height = "100vh")
                            }, 5);
                            eo.build(this._activeEl)
                        }
                    }, {
                        key: "exitFullscreen",
                        value: function () {
                            var n = this;
                            this._overlayEl && (this._overlayEl.style.width = "".concat(this._width, "px"), this._overlayEl.style.height = "".concat(this._height, "px"), this._overlayEl.style.top = "".concat(this._top, "px"), this._overlayEl.style.left = "".concat(this._left, "px"), setTimeout(function () {
                                var t;
                                null === (t = n._activeEl) || void 0 === t || t.remove();
                                n._overlayEl && (n._overlayEl.remove(), n._overlayEl = void 0);
                                n._activeEl = void 0;
                ...
                ro = [new cu("language", function (n) {
                    return hu.getLanguage(n)
                }, "", function () {}, function (n) {
                    return !!hu.getLanguage(n)
                }), new cu("copy", "复制", '<svg class="cnb-code-toolbar-icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><path d="M878.250667 981.333333H375.338667a104.661333 104.661333 0 0 1-104.661334-104.661333V375.338667a104.661333 104.661333 0 0 1 104.661334-104.661334h502.912a104.661333 104.661333 0 0 1 104.661333 104.661334v502.912C981.333333 934.485333 934.485333 981.333333 878.250667 981.333333zM375.338667 364.373333a10.666667 10.666667 0 0 0-10.922667 10.965334v502.912c0 6.229333 4.693333 10.922667 10.922667 10.922666h502.912a10.666667 10.666667 0 0 0 10.922666-10.922666V375.338667a10.666667 10.666667 0 0 0-10.922666-10.922667H375.338667z" ><\/path><path d="M192.597333 753.322667H147.328A104.661333 104.661333 0 0 1 42.666667 648.661333V147.328A104.661333 104.661333 0 0 1 147.328 42.666667H650.24a104.661333 104.661333 0 0 1 104.618667 104.661333v49.962667c0 26.538667-20.309333 46.848-46.848 46.848a46.037333 46.037333 0 0 1-46.848-46.848V147.328a10.666667 10.666667 0 0 0-10.922667-10.965333H147.328a10.666667 10.666667 0 0 0-10.965333 10.965333V650.24c0 6.229333 4.693333 10.922667 10.965333 10.922667h45.269333c26.538667 0 46.848 20.309333 46.848 46.848 0 26.538667-21.845333 45.312-46.848 45.312z" ><\/path><\/svg>', function (n, t) {
                    hu.copyCode(t).then(function (i) {
                        if (i) {
                            var r = n.innerHTML;
                            ot()(r).call(r, io) || (n.innerHTML = "".concat(io, " 复制成功"), ri(t), n.addEventListener("mouseleave", function () {
                                n.innerHTML = r;
                                ri(t)
                            }, {
                                once: !0
                ...
                }), new cu("fullscreen", "全屏", '<svg class="cnb-code-toolbar-icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><path d="M149.52928355 149.52928355h258.90765513V45.96622222H97.74775349a51.78153127 51.78153127 0 0 0-51.78153127 51.78153127v310.68918519h103.56306133V149.52928355zM97.74775349 978.03377778h310.68918519v-103.56306133H149.52928355v-258.90765513H45.96622222v310.68918519a51.78153127 51.78153127 0 0 0 51.78153127 51.78153127z m880.28602429-51.78153127v-310.68918519h-103.56306133v258.90765513h-258.90765513v103.56306133h310.68918519a51.78153127 51.78153127 0 0 0 51.78153127-51.78153127zM615.56306132 149.52928355h258.90765513v258.90765513h103.56306133V97.74775349a51.78153127 51.78153127 0 0 0-51.78153127-51.78153127h-310.68918519v103.56306133z" fill="" ><\/path><\/svg>', function (n, t) {
                    cr.isElementFullscreen(t) ? cr.exitFullscreen() : cr.enterFullscreen(t)
                })],
                uo = function (n) {
                    var i, t, r;
                    (function (n) {
                        var t, i;
                        return n && !(null !== (t = null === (i = n.parentElement) || void 0 === i ? void 0 : i.classList.contains("cnblogs_code")) && void 0 !== t && t) && 1 === n.children.length && "true" === n.getAttribute("highlighted") && !!n.querySelector("code")
                    })(n) && (n.setAttribute("cnb-code-toolbar-active", "true"), t = document.createElement("div"), r = g()(i = st()(ro).call(ro, function (t) {
                        return t.isEnabled(n)
                    })).call(i, function (t) {
                        var f, e, o, i = document.createElement("span"),
                            r = "string" == typeof t.name ? t.name : t.name(n),
                            u = t.icon;
                        return i.innerHTML = a()(f = a()(e = "".concat(null != u ? u : "")).call(e, r && u ? " " : "")).call(f, null != r ? r : ""), i.classList.add("cnb-code-toolbar-item"), i.setAttribute("cnb-code-toolbar-item-id", a()(o = "".concat(t.idPrefix, "-")).call(o, Date.now())), i.addEventListener("click", function () {
                            return t.handler(i, n)
                        }), i
                    }), t.classList.add("cnb-code-toolbar"), t.append.apply(t, vt(r)), n.appendChild(t), n.addEventListener("scroll", fo), ri(n))
                },
                fo = function (n) {
                    ri(n.currentTarget)
                },
                ri = function (n) {
                    var r = n.scrollLeft,
                        t = n.querySelector(".cnb-code-toolbar"),
                        i;
                    t && (i = lc()(window.getComputedStyle(t).getPropertyValue("--cnb-code-toolbar-spacing").split("px")[0]), t.style.left = r + n.offsetWidth - i + "px")
                },
                eo = function () {
                    function n() {
                        k(this, n)
                    ...
                    return d(n, null, [{
                        ...
                        value: function (n) {
                            var t = function () {
                                ...
                                i = function () {
                                    return function (n) {
                                        var i = n.querySelector(".cnb-code-toolbar"),
                                            r, u, f, t;
                                        i && (i.style.opacity = "0", t = hc()((null !== (r = null === (u = window.getComputedStyle(i)) || void 0 === u || null === (f = u.getPropertyValue("--cnb-code-toolbar-animation-duration")) || void 0 === f ? void 0 : f.split("s")) && void 0 !== r ? r : ["0.1"])[0]), t = isNaN(t) || !t ? .1 : t, setTimeout(function () {
                                            i.remove();
                                            n.removeEventListener("scroll", fo);
                                            n.removeAttribute("cnb-code-toolbar-active")
                                        }, 1e3 * t))
                                    }(n)
                                },
                                r = n.querySelector(".cnb-code-toolbar");
                            r && (r.remove(), uo(n), n.removeEventListener("mouseover", t), n.removeEventListener("mouseleave", i));
                ...
                il = function () {
                    ! function () {
                        var t, i, r, u, f, h = document.head.querySelector('link[href*="css/blog-common.min.css"]'),
                            e = document.createElement("style"),
                            n;
                        document.head.insertBefore(e, h);
                        n = document.createElement("pre");
                        n.style.display = "none !important";
                        n.classList.add(1 === codeHighlightEngine ? "hljs" : "language-none");
                        document.head.append(n);
                        var o = getComputedStyle(n).backgroundColor,
                            c = getComputedStyle(n).borderRadius,
                            l = getComputedStyle(n).border,
                            v = getComputedStyle(n).padding,
                            y = getComputedStyle(n).color,
                            p = getComputedStyle(n).fontFamily,
                            s = a()(t = a()(i = a()(r = a()(u = a()(f = "".concat(':not(.cnblogs_code):not(.cnblogs_Highlighter)>pre:not([class*="language-"]):not([highlighted]):not(.hljs)', " {\n        background: ").concat(o, ";\n        padding: ")).call(f, v, ";\n        border: ")).call(u, l, ";\n        border-radius: ")).call(r, c, ";\n        border-color: transparent;\n        color: ")).call(i, y, ";\n        font-family: ")).call(t, p, ";\n    }");
                    ...
                    var n = tl.Factory.CreateCodeHighlighter(2 === codeHighlightEngine || $(".blogpost-body-html pre:has(code.prism)").length ? "prismjs" : "highlight.js", codeHighlightTheme, function () {
                        return {
                            enableCodeLineNumber: lr.enableCodeLineNumber,
                            prism: {
                                highlighterScriptPath: "https://common.cnblogs.com/prism/prism.js?v=1.23.0",
                                lineNumberPluginPath: "https://common.cnblogs.com/prism/plugins/line-numbers/prism-line-numbers.min.js",
                                themeBaseUrl: "https://www.cnblogs.com/css/prismjs",
                            ...
                            hljs: {
                                highlighterScriptPath: "https://common.cnblogs.com/highlight/11.4.0/highlight.min.js",
                                lineNumberPluginPath: "https://common.cnblogs.com/scripts/highlightjs-line-numbers.min.js",
                                themeBaseUrl: "https://www.cnblogs.com/css/hljs",
                                defaultTheme: "cnblogs",
                                stylesheets: []
                    ...
                    return n.ensureResourcesLoaded().then(function () {
                        return lu = !0
                    }), n
                },
                rl = function () {
                    return lu ? oo().resolve() : new(oo())(function (n) {
                        var i = 0,
                            t = setInterval(function () {
                                if (lu) return n(), void clearInterval(t);
                                var r;
                                if (20 * i++ > 6e4) throw clearInterval(t), Error(a()(r = "Failed to load highlighter, engine: ".concat(codeHighlightEngine, ", theme: ")).call(r, codeHighlightTheme));
                            }, 20)
                    })
                },
                ul = function (n) {
                    var t, r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "#cnblogs_post_body",
                        i = [];
                    return g()(t = pi()($(r + " pre:has(code)"))).call(t, function (n) {
                        return n
                    }).forEach(function (t) {
                        var u, r;
                        null !== (u = t.parentElement) && void 0 !== u && u.classList.contains("cnblogs_code") || (r = t.querySelector("code"), r && (i.push({
                            preEl: t,
                            codeEl: r
                        }), n(t, r)))
                    }), i
                ...
                fl = function (n) {
                    var i, r, t;
                    n && (i = pi()(n.querySelectorAll("code")), i.length <= 1 || (r = document.createElement("code"), r.innerText = a()("").apply("", vt(g()(i).call(i, function (n) {
                        var t;
                        return gc()(t = n.innerText).call(t, "\n") ? n.innerText : "".concat(n.innerText, "\n")
                    }))), t = n.getAttribute("data-lang"), t && (t = ot()(t).call(t, "language-") ? t : "language-".concat(t), r.classList.add(t)), n.innerHTML = r.outerHTML))
                };
            lo = function () {
                function n() {
                    k(this, n)
                ...
                return d(n, [{
                    key: "updateVisitorPreference",
                    value: function () {
                        $.ajax({
                            type: "get",
                            url: "/pref",
                            success: function (n) {
                                n && (n.liteMode ? $("#navbar_lite_mode_on").show() : $("#navbar_lite_mode_on").hide())
                            }
                        })
                    }
                }, {
                    key: "init",
                    value: function () {
                        this.updateVisitorPreference();
                        var n = this;
                        $("#navbar_lite_mode_toggle").on("click", function () {
                            return $("#navbar_lite_mode_spinner").show(), $.ajax({
                                type: "post",
                                url: "/pref",
                                dataType: "text",
                                data: su()({
                                    liteMode: !$("#navbar_lite_mode_on").is(":visible")
                                }),
                                success: function () {
                                    $("#navbar_lite_mode_spinner").hide();
                                    n.updateVisitorPreference()
                                },
                                error: function () {
                                    $("#navbar_lite_mode_spinner").hide();
                                    alert("简洁模式更新失败")
            ...
            ! function () {
                lr.markdown_highlight = el;
                lr.cb_CodeHighlight = co;
                lr.highlighter = il()
            }();
            window.zoomManager = new gh;
            window.account = new po;
            window.reportManager = new vh;
            window.tocManager = new hh;
            window.liteMode = new lo;
            $(function () {
                window.liteMode.init(),
                    function () {
                        pi()(document.querySelectorAll("pre")).forEach(eo.build);
                        document.addEventListener("selectionchange", function () {
                            var n = "has-selection";
                            document.querySelectorAll(".cnb-code-toolbar").forEach(function (t) {
                                var i = t.parentElement,
                                    r = document.getSelection(),
                                    u = i.querySelector("code");
                                !cr.isElementFullscreen(i) && u && null != r && r.containsNode(u, !0) && "Range" === (null == r ? void 0 : r.type) ? i.setAttribute(n, "true") : i.hasAttribute(n) && (i.removeAttribute(n), ri(i))
                            })
                        });
                        window.addEventListener("orientationchange", function () {
                            document.querySelectorAll(".cnb-code-toolbar").forEach(function (n) {
    ...
    $.ajax({
        ...
        success: function (n) {
            if (n) {
                ...
                n.unreadMsg === 0 ? $("#msg_count").hide() : ($("#msg_count").text(n.unreadMsg === 0 ? "" : n.unreadMsg), $("#msg_count").show());
...
getMarkdownEditor = function (n) {
    var t = {};
    return t.textbox = document.getElementById(n), t.config = {
        ...
        } else t.replaceSelectionWith(n + o + i);
        t.textbox.focus()
        ...
        var i, r;
        return n < 0 ? (i = t.textbox.selectionStart, t.textbox.value.substring(i + n, i)) : (r = t.textbox.selectionEnd, t.textbox.value.substring(r, r + n))
        ...
        t.hasSelection() ? (t.textbox.selectionStart += n, t.textbox.selectionEnd += n) : n > 0 ? t.textbox.selectionStart += n : t.textbox.selectionEnd += n
        ...
        for (var r = 0; r < t.bracketMatchPairs.length; r++) {
            ...
            if (n === i.right && f) return t.moveCaretBy(i.right.length), !0;
            if (n === (i.trigger || i.left)) {
                if (t.hasSelection()) {
                    if (!i.needLeftMatch) return t.wrapSelectionWith(i.left, i.right), !0;
                    continue
                }
                if (u && i.needLeftMatch) return t.insertToCaret(i.right), t.moveCaretBy(-(i.moveBack || i.right.length)), !0;
                if (!i.needLeftMatch) return t.insertToCaret(i.left + i.right), t.moveCaretBy(-(i.moveBack || i.right.length)), !0
            }
        }
        return !1
    }, t.bold = function () {
        ...
        var r, f, u, i, e, o, s;
        if (n.isComposing || n.keyCode === 229) return !0;
        for (r = 0; r < t.hotKeyMap.length; r++) {
            for (f = !0, u = t.hotKeyMap[r].key.split("+"), i = 0; i < u.length; i++) f &= u[i].toLowerCase() === "ctrl".toLowerCase() ? n.ctrlKey || n.metaKey : u[i].toLowerCase() === "shift".toLowerCase() ? n.shiftKey : n.key.toLowerCase() === u[i].toLowerCase();
            if (f) return t.hotKeyMap[r].action(), !1
        }
        if (!t.config.enableAutoCompletion) return !0;
        if (t.bracketMatch(n.key)) return !1;
        if (n.key === "Enter") {
            if (e = t.getCurrentLine(), e.substring(0, 2) === "* ") return t.insertToCaret("\n* "), !1;
...
initCommentEditor = function (n) {
    ...
    t.preview = function () {
        ...
        if ($(".commentbox_title_right").hide(), $(".commentbox_footer").hide(), n = $.trim($("#tbCommentBody").val()), $("#tbCommentBody").hide(), $("#tbCommentBodyPreview").show(), $("#tbCommentBodyPreviewBody").html("正在加载预览……"), n.length > 4e3) {
        ...
        $.ajax({
            ...
            timeout: 5e3,
            success: function (n) {
                if (n) $("#tbCommentBodyPreviewBody").html(n.message), markdown_highlight("#tbCommentBodyPreviewBody"), $("#btn_comment_submit").removeAttr("disabled");
                else $("#tbCommentBodyPreviewBody").html("抱歉！预览加载失败！请与管理员联系(contact@cnblogs.com)。"), $("#btn_comment_submit").removeAttr("disabled")
            },
            error: function (n, t) {
                ...
                return dialog({
                    ...
                    ok: function () {
                        ...
                        $.ajax({
                            ...
                            success: function (i) {
                                n.close().remove();
                                i ? i.success ? (t.dialogs.success("订阅成功！<a href='/subscription'>查看订阅<\/a>").show(), t.updateSubscribeStatus(!0)) : t.dialogs.error("订阅失败！").show() : t.dialogs.error("订阅失败！").show()
                            },
                            error: function (i) {
                                n.close().remove();
                ...
                return dialog({
                    ...
                    ok: function () {
                        ...
                        $.ajax({
                            ...
                            success: function (i) {
                                n.close().remove();
                                i ? i.success ? (t.dialogs.success("取消订阅成功！").show(), t.updateSubscribeStatus(!1)) : t.dialogs.error(i.message).show() : t.dialogs.error("取消订阅失败！").show()
                            },
                            error: function (i) {
                                n.close().remove();
                ...
                loadLink(location.protocol + "//common.cnblogs.com/scripts/artDialog/ui-dialog.css", function () {
                    loadScript(location.protocol + "//common.cnblogs.com/scripts/artDialog/dialog-plus-min.js", function () {
                        ...
                        return $.ajax({
                            ...
                            dataType: "json",
                            success: function (i) {
                                i ? (n.close(), i.isAuthenticated ? i.isBlogOwner ? t.dialogs.error("园友可以通过此链接订阅您的博客").show() : i.isSubscribed ? t.unsubscribe() : t.subscribe() : t.login()) : t.dialogs.error("发生错误！").show()
                            },
                            error: function (n) {
...
tagOrderer = function (n, t, i, r) {
    var u = {};
    return u.manager = r, u.label = document.getElementById(n), u.name = document.getElementById(n).innerText, u.isActive = i, u.isDesc = !1, u.orderMethod = t, u.click = function () {
    ...
    }, u.label.addEventListener("click", u.click), u
};
initTagsManager = function () {
    var n = {};
    return n.tags = $("#MyTag1_dtTagList td").get(), n.generateTagList = function () {
        for (var r, t, u, f = Math.ceil(n.tags.length / 4), e = document.createElement("tbody"), i = 0; i < f; i++) {
            for (r = document.createElement("tr"), t = 0; t < 4; t++) u = i + t * f, u < n.tags.length && r.appendChild(n.tags[u]);
            e.appendChild(r)
        }
    ...
    }, !1, n), ], n.deactiveAll = function () {
        n.orderers.forEach(function (n) {
            n.isActive = !1
        })
    }, n.orderers[0].click(), n
};
$.ajaxSetup({
    type: "post",
    dataType: "json",
...
buildVoteNode = function (n, t) {
    var i = {};
    return i.digg = $(t).children(".comment_digg").get(0), i.bury = $(t).children(".comment_burry").get(0), i.errorMessage = $(t).children(".comment_error").get(0), i.current = n === "Digg" ? i.digg : i.bury, i.getCommentVoteCount = function (n) {
...
$(function () {
    updateVisitorPreference();
    $("#navbar_lite_mode_toggle").on("click", function () {
        var n = typeof currentBlogId != "undefined";
        return $("#navbar_lite_mode_spinner").show(), $.ajax({
            type: "post",
            url: "/pref",
            dataType: "text",
